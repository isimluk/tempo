...
module OpenapiClient
  class TimesheetApproval
    ...
    attr_accessor :required_seconds
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TimesheetApproval` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TimesheetApproval`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'required_seconds')
        self.required_seconds = attributes[:'required_seconds']
      end
      ...
      if attributes.key?(:'worklogs')
        self.worklogs = attributes[:'worklogs']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @required_seconds.nil?
        invalid_properties.push('invalid value for "required_seconds", required_seconds cannot be nil.')
      end
      ...
      if @worklogs.nil?
        invalid_properties.push('invalid value for "worklogs", worklogs cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          actions == o.actions &&
          period == o.period &&
          required_seconds == o.required_seconds &&
          reviewer == o.reviewer &&
          _self == o._self &&
          status == o.status &&
    ...
    def hash
      [actions, period, required_seconds, reviewer, _self, status, time_spent_seconds, user, worklogs].hash
    end
