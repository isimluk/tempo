  ...
  class PlanDay
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PlanDay` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PlanDay`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'planned_seconds')
        self.planned_seconds = attributes[:'planned_seconds']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @planned_seconds.nil?
        invalid_properties.push('invalid value for "planned_seconds", planned_seconds cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @planned_seconds.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          date == o.date &&
          planned_seconds == o.planned_seconds
    end
