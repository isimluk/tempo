...
module OpenapiClient
  class WorkAttributeValuesInput
    ...
    def self.openapi_types
      {
        :'attribute_values' => :'Array<WorkAttributeValueInput>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WorkAttributeValuesInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WorkAttributeValuesInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tempo_worklog_id')
        self.tempo_worklog_id = attributes[:'tempo_worklog_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @attribute_values.length > 2147483647
        invalid_properties.push('invalid value for "attribute_values", number of items must be less than or equal to 2147483647.')
      end

      if @attribute_values.length < 1
        invalid_properties.push('invalid value for "attribute_values", number of items must be greater than or equal to 1.')
      end

      if @tempo_worklog_id.nil?
        invalid_properties.push('invalid value for "tempo_worklog_id", tempo_worklog_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @attribute_values.length > 2147483647
      return false if @attribute_values.length < 1
      return false if @tempo_worklog_id.nil?
      true
    end
    ...
    def attribute_values=(attribute_values)
      ...
      if attribute_values.length > 2147483647
        fail ArgumentError, 'invalid value for "attribute_values", number of items must be less than or equal to 2147483647.'
      end

      if attribute_values.length < 1
        fail ArgumentError, 'invalid value for "attribute_values", number of items must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tempo_worklog_id == o.tempo_worklog_id
    end
    ...
    def hash
      [attribute_values, tempo_worklog_id].hash
    end
