...
module OpenapiClient
  class WorklogInput
    ...
    attr_accessor :author_account_id

    # The amount of seconds billable
    attr_accessor :billable_seconds
    ...
    attr_accessor :remaining_estimate_seconds
    ...
    attr_accessor :time_spent_seconds
    ...
    def self.openapi_types
      {
        :'attributes' => :'Array<WorkAttributeValueInput>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WorklogInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WorklogInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'author_account_id')
        self.author_account_id = attributes[:'author_account_id']
      end

      if attributes.key?(:'billable_seconds')
        self.billable_seconds = attributes[:'billable_seconds']
      end
      ...
      if attributes.key?(:'remaining_estimate_seconds')
        self.remaining_estimate_seconds = attributes[:'remaining_estimate_seconds']
      end
      ...
      if attributes.key?(:'time_spent_seconds')
        self.time_spent_seconds = attributes[:'time_spent_seconds']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @author_account_id.nil?
        invalid_properties.push('invalid value for "author_account_id", author_account_id cannot be nil.')
      end
      ...
      if @issue_id < 1
        invalid_properties.push('invalid value for "issue_id", must be greater than or equal to 1.')
      end
      ...
      pattern = Regexp.new(/^([0-1]?[0-9]|2[0-3])(:[0-5][0-9])(:[0-5][0-9])$/)
      ...
      if @time_spent_seconds.nil?
        invalid_properties.push('invalid value for "time_spent_seconds", time_spent_seconds cannot be nil.')
      end

      if @time_spent_seconds < 1
        invalid_properties.push('invalid value for "time_spent_seconds", must be greater than or equal to 1.')
      end
    ...
    def valid?
      return false if @author_account_id.nil?
      return false if @issue_id.nil?
      return false if @issue_id < 1
      return false if @start_date.nil?
      return false if !@start_time.nil? && @start_time !~ Regexp.new(/^([0-1]?[0-9]|2[0-3])(:[0-5][0-9])(:[0-5][0-9])$/)
      return false if @time_spent_seconds.nil?
      return false if @time_spent_seconds < 1
      true
    end
    ...
    def issue_id=(issue_id)
      if issue_id.nil?
        fail ArgumentError, 'issue_id cannot be nil'
      end

      if issue_id < 1
        fail ArgumentError, 'invalid value for "issue_id", must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] time_spent_seconds Value to be assigned
    def time_spent_seconds=(time_spent_seconds)
      if time_spent_seconds.nil?
        fail ArgumentError, 'time_spent_seconds cannot be nil'
      end

      if time_spent_seconds < 1
        fail ArgumentError, 'invalid value for "time_spent_seconds", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          author_account_id == o.author_account_id &&
          billable_seconds == o.billable_seconds &&
          description == o.description &&
          issue_id == o.issue_id &&
          remaining_estimate_seconds == o.remaining_estimate_seconds &&
          start_date == o.start_date &&
          start_time == o.start_time &&
          time_spent_seconds == o.time_spent_seconds
    end
    ...
    def hash
      [attributes, author_account_id, billable_seconds, description, issue_id, remaining_estimate_seconds, start_date, start_time, time_spent_seconds].hash
    end
