  ...
  class WorkloadScheme
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WorkloadScheme` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WorkloadScheme`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'default_scheme')
        self.default_scheme = attributes[:'default_scheme']
      end
    ...
    def list_invalid_properties
      ...
      if @default_scheme.nil?
        invalid_properties.push('invalid value for "default_scheme", default_scheme cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @default_scheme.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          days == o.days &&
          default_scheme == o.default_scheme &&
    ...
    def hash
      [days, default_scheme, description, id, member_count, name, _self].hash
    end
