  ...
  class PlanSearchInput
    ...
    def self.attribute_map
      {
        ...
        :'assignee_types' => :'assigneeTypes',
        :'from' => :'from',
        :'generic_resource_ids' => :'genericResourceIds',
        :'limit' => :'limit',
        :'offset' => :'offset',
        :'plan_ids' => :'planIds',
    ...
    def self.openapi_types
      {
        ...
        :'from' => :'String',
        :'generic_resource_ids' => :'Array<Integer>',
        :'limit' => :'Integer',
        :'offset' => :'Integer',
        :'plan_ids' => :'Array<Integer>',
        :'plan_item_ids' => :'Array<Integer>',
        :'plan_item_types' => :'Array<String>',
        :'planned_time_breakdown' => :'Array<String>',
        :'to' => :'String',
        :'updated_from' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PlanSearchInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PlanSearchInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'assignee_types')
        if (value = attributes[:'assignee_types']).is_a?(Array)
          self.assignee_types = value
        end
      end
      ...
      if attributes.key?(:'generic_resource_ids')
        if (value = attributes[:'generic_resource_ids']).is_a?(Array)
          self.generic_resource_ids = value
        end
      end
      ...
      if attributes.key?(:'plan_item_ids')
        if (value = attributes[:'plan_item_ids']).is_a?(Array)
          self.plan_item_ids = value
        end
      end

      if attributes.key?(:'plan_item_types')
        if (value = attributes[:'plan_item_types']).is_a?(Array)
          self.plan_item_types = value
        end
      end

      if attributes.key?(:'planned_time_breakdown')
        if (value = attributes[:'planned_time_breakdown']).is_a?(Array)
          self.planned_time_breakdown = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          assignee_types == o.assignee_types &&
          from == o.from &&
          generic_resource_ids == o.generic_resource_ids &&
          limit == o.limit &&
          offset == o.offset &&
          plan_ids == o.plan_ids &&
          plan_item_ids == o.plan_item_ids &&
          plan_item_types == o.plan_item_types &&
          planned_time_breakdown == o.planned_time_breakdown &&
          to == o.to &&
    ...
    def hash
      [account_ids, assignee_types, from, generic_resource_ids, limit, offset, plan_ids, plan_item_ids, plan_item_types, planned_time_breakdown, to, updated_from].hash
    end
