...
module OpenapiClient
  class PermissionRole
    ...
    def self.attribute_map
      {
        :'access_entities' => :'accessEntities',
    ...
    def self.openapi_types
      {
        :'access_entities' => :'Array<Entity>',
        :'access_type' => :'String',
        :'editable' => :'Boolean',
        :'id' => :'Integer',
        :'name' => :'String',
        :'permissions' => :'Array<Permission>',
        :'permitted_users' => :'Array<User>',
        :'_self' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PermissionRole` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PermissionRole`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'access_entities')
        if (value = attributes[:'access_entities']).is_a?(Array)
          self.access_entities = value
        end
      end
      ...
      if attributes.key?(:'permitted_users')
        if (value = attributes[:'permitted_users']).is_a?(Array)
          self.permitted_users = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @access_entities.nil?
        invalid_properties.push('invalid value for "access_entities", access_entities cannot be nil.')
      end
      ...
      if @permitted_users.nil?
        invalid_properties.push('invalid value for "permitted_users", permitted_users cannot be nil.')
      end
    ...
    def valid?
      return false if @access_entities.nil?
      ...
      return false if @permitted_users.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          access_entities == o.access_entities &&
          access_type == o.access_type &&
          editable == o.editable &&
          id == o.id &&
          name == o.name &&
          permissions == o.permissions &&
          permitted_users == o.permitted_users &&
          _self == o._self
    end
    ...
    def hash
      [access_entities, access_type, editable, id, name, permissions, permitted_users, _self].hash
    end
