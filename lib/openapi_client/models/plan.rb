...
module OpenapiClient
  class Plan
    ...
    attr_accessor :total_planned_seconds_in_scope
    ...
    def self.attribute_map
      {
        ...
        :'total_planned_seconds_in_scope' => :'totalPlannedSecondsInScope'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'_self' => :'String',
        :'start_date' => :'String',
        :'total_planned_seconds_in_scope' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'plan_item')
        self.plan_item = attributes[:'plan_item']
      end
      ...
      if attributes.key?(:'planned_time')
        self.planned_time = attributes[:'planned_time']
      end
      ...
      if attributes.key?(:'total_planned_seconds_in_scope')
        self.total_planned_seconds_in_scope = attributes[:'total_planned_seconds_in_scope']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_planned_seconds_in_scope == o.total_planned_seconds_in_scope
    end
    ...
    def hash
      [assignee, description, end_date, id, include_non_working_days, plan_approval, plan_item, planned_seconds_per_day, planned_time, recurrence_end_date, rule, _self, start_date, total_planned_seconds_in_scope].hash
    end
