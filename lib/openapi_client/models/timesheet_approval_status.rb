...
module OpenapiClient
  ...
  class TimesheetApprovalStatus
    ...
    attr_accessor :required_seconds_at_submit

    # The total seconds spent on this timesheet
    attr_accessor :time_spent_seconds_at_submit
    ...
    def self.attribute_map
      {
        ...
        :'comment' => :'comment',
        :'key' => :'key',
        :'required_seconds_at_submit' => :'requiredSecondsAtSubmit',
        :'time_spent_seconds_at_submit' => :'timeSpentSecondsAtSubmit',
    ...
    def self.openapi_types
      {
        ...
        :'comment' => :'String',
        :'key' => :'String',
        :'required_seconds_at_submit' => :'Integer',
        :'time_spent_seconds_at_submit' => :'Integer',
        :'updated_at' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TimesheetApprovalStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TimesheetApprovalStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'required_seconds_at_submit')
        self.required_seconds_at_submit = attributes[:'required_seconds_at_submit']
      end

      if attributes.key?(:'time_spent_seconds_at_submit')
        self.time_spent_seconds_at_submit = attributes[:'time_spent_seconds_at_submit']
      end
    ...
    def valid?
      key_validator = EnumAttributeValidator.new('String', ["OPEN", "IN_REVIEW", "APPROVED"])
    ...
    def key=(key)
      validator = EnumAttributeValidator.new('String', ["OPEN", "IN_REVIEW", "APPROVED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          comment == o.comment &&
          key == o.key &&
          required_seconds_at_submit == o.required_seconds_at_submit &&
          time_spent_seconds_at_submit == o.time_spent_seconds_at_submit &&
    ...
    def hash
      [actor, comment, key, required_seconds_at_submit, time_spent_seconds_at_submit, updated_at].hash
    end
