...
module OpenapiClient
  class AccountInput
    ...
    attr_accessor :contact_account_id
    ...
    attr_accessor :external_contact_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AccountInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AccountInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'category_key')
        self.category_key = attributes[:'category_key']
      end

      if attributes.key?(:'contact_account_id')
        self.contact_account_id = attributes[:'contact_account_id']
      end
      ...
      if attributes.key?(:'external_contact_name')
        self.external_contact_name = attributes[:'external_contact_name']
      end
      ...
      if attributes.key?(:'lead_account_id')
        self.lead_account_id = attributes[:'lead_account_id']
      end

      if attributes.key?(:'monthly_budget')
        self.monthly_budget = attributes[:'monthly_budget']
      end
    ...
    def list_invalid_properties
      ...
      if @lead_account_id.nil?
        invalid_properties.push('invalid value for "lead_account_id", lead_account_id cannot be nil.')
      end

      if !@monthly_budget.nil? && @monthly_budget < 0
        invalid_properties.push('invalid value for "monthly_budget", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @lead_account_id.nil?
      return false if !@monthly_budget.nil? && @monthly_budget < 0
      return false if @name.nil?
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ["CLOSED", "OPEN", "ARCHIVED"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] monthly_budget Value to be assigned
    def monthly_budget=(monthly_budget)
      if !monthly_budget.nil? && monthly_budget < 0
        fail ArgumentError, 'invalid value for "monthly_budget", must be greater than or equal to 0.'
      end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["CLOSED", "OPEN", "ARCHIVED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          contact_account_id == o.contact_account_id &&
          customer_key == o.customer_key &&
          external_contact_name == o.external_contact_name &&
          global == o.global &&
          key == o.key &&
          lead_account_id == o.lead_account_id &&
    ...
    def hash
      [category_key, contact_account_id, customer_key, external_contact_name, global, key, lead_account_id, monthly_budget, name, status].hash
    end
