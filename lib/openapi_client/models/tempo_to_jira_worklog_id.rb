...
module OpenapiClient
  class TempoToJiraWorklogId
    # A unique identifier of the Worklog in Jira
    attr_accessor :jira_worklog_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TempoToJiraWorklogId` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TempoToJiraWorklogId`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'jira_worklog_id')
        self.jira_worklog_id = attributes[:'jira_worklog_id']
      end
    ...
    def list_invalid_properties
      ...
      if @jira_worklog_id.nil?
        invalid_properties.push('invalid value for "jira_worklog_id", jira_worklog_id cannot be nil.')
      end
    ...
    def valid?
      return false if @jira_worklog_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          jira_worklog_id == o.jira_worklog_id &&
    ...
    def hash
      [jira_worklog_id, tempo_worklog_id].hash
    end
