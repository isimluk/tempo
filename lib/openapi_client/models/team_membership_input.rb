...
module OpenapiClient
  class TeamMembershipInput
    ...
    attr_accessor :commitment_percent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TeamMembershipInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TeamMembershipInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'commitment_percent')
        self.commitment_percent = attributes[:'commitment_percent']
      end
    ...
    def list_invalid_properties
      ...
      if !@commitment_percent.nil? && @commitment_percent > 100
        invalid_properties.push('invalid value for "commitment_percent", must be smaller than or equal to 100.')
      end

      if !@commitment_percent.nil? && @commitment_percent < 0
        invalid_properties.push('invalid value for "commitment_percent", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@commitment_percent.nil? && @commitment_percent > 100
      return false if !@commitment_percent.nil? && @commitment_percent < 0
      return false if @team_id.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] commitment_percent Value to be assigned
    def commitment_percent=(commitment_percent)
      if !commitment_percent.nil? && commitment_percent > 100
        fail ArgumentError, 'invalid value for "commitment_percent", must be smaller than or equal to 100.'
      end

      if !commitment_percent.nil? && commitment_percent < 0
        fail ArgumentError, 'invalid value for "commitment_percent", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          commitment_percent == o.commitment_percent &&
          from == o.from &&
          role_id == o.role_id &&
          team_id == o.team_id &&
          to == o.to
    ...
    def hash
      [account_id, commitment_percent, from, role_id, team_id, to].hash
    end
