...
module OpenapiClient
  class GenericResourceTeamMember
    # Timestamp (in UTC) of when this `Generic Resource` was added to this team
    attr_accessor :assigned_to_team_at

    attr_accessor :assigned_to_team_by
    ...
    def self.attribute_map
      {
        :'assigned_to_team_at' => :'assignedToTeamAt',
        :'assigned_to_team_by' => :'assignedToTeamBy',
        :'member' => :'member',
        :'_self' => :'self',
        :'team' => :'team'
      }
    ...
    def self.openapi_types
      {
        :'assigned_to_team_at' => :'String',
        :'assigned_to_team_by' => :'UserRefBean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GenericResourceTeamMember` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GenericResourceTeamMember`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'assigned_to_team_at')
        self.assigned_to_team_at = attributes[:'assigned_to_team_at']
      end

      if attributes.key?(:'assigned_to_team_by')
        self.assigned_to_team_by = attributes[:'assigned_to_team_by']
      end
    ...
    def list_invalid_properties
      ...
      if @assigned_to_team_at.nil?
        invalid_properties.push('invalid value for "assigned_to_team_at", assigned_to_team_at cannot be nil.')
      end

      if @assigned_to_team_by.nil?
        invalid_properties.push('invalid value for "assigned_to_team_by", assigned_to_team_by cannot be nil.')
      end
    ...
    def valid?
      return false if @assigned_to_team_at.nil?
      return false if @assigned_to_team_by.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          assigned_to_team_at == o.assigned_to_team_at &&
          assigned_to_team_by == o.assigned_to_team_by &&
          member == o.member &&
          _self == o._self &&
          team == o.team
    end
    ...
    def hash
      [assigned_to_team_at, assigned_to_team_by, member, _self, team].hash
    end
