...
module OpenapiClient
  class PermissionRoleInput
    # A list of access entity ids
    attr_accessor :access_entity_ids
    ...
    attr_accessor :permission_keys

    # A list of permitted account ids
    attr_accessor :permitted_account_ids
    ...
    def self.attribute_map
      {
        :'access_entity_ids' => :'accessEntityIds',
        :'access_type' => :'accessType',
        :'name' => :'name',
        :'permission_keys' => :'permissionKeys',
        :'permitted_account_ids' => :'permittedAccountIds'
      }
    end
    ...
    def self.openapi_types
      {
        :'access_entity_ids' => :'Array<Integer>',
        :'access_type' => :'String',
        :'name' => :'String',
        :'permission_keys' => :'Array<String>',
        :'permitted_account_ids' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PermissionRoleInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PermissionRoleInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'access_entity_ids')
        if (value = attributes[:'access_entity_ids']).is_a?(Array)
          self.access_entity_ids = value
        end
      end
      ...
      if attributes.key?(:'permission_keys')
        if (value = attributes[:'permission_keys']).is_a?(Array)
          self.permission_keys = value
        end
      end

      if attributes.key?(:'permitted_account_ids')
        if (value = attributes[:'permitted_account_ids']).is_a?(Array)
          self.permitted_account_ids = value
        end
      end
    end
    ...
    def valid?
      ...
      access_type_validator = EnumAttributeValidator.new('String', ["TEAM", "GLOBAL"])
    ...
    def access_type=(access_type)
      validator = EnumAttributeValidator.new('String', ["TEAM", "GLOBAL"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          access_entity_ids == o.access_entity_ids &&
          access_type == o.access_type &&
          name == o.name &&
          permission_keys == o.permission_keys &&
          permitted_account_ids == o.permitted_account_ids
    end
    ...
    def hash
      [access_entity_ids, access_type, name, permission_keys, permitted_account_ids].hash
    end
