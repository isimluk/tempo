...
module OpenapiClient
  class SkillsApi
    ...
    # @option opts [SkillInput] :skill_input 
    # @return [Skill]
    def create_skill(opts = {})
      data, _status_code, _headers = create_skill_with_http_info(opts)
      data
    end
    ...
    def create_skill_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillsApi.create_skill ...'
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'skill_input'])
      ...
      new_options = opts.merge(
        :operation => :"SkillsApi.create_skill",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillsApi#create_skill\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [Integer] An id that uniquely identifies the Skill
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_skill(id, opts = {})
      delete_skill_with_http_info(id, opts)
      nil
    end
    ...
    def delete_skill_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillsApi.delete_skill ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SkillsApi.delete_skill"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"SkillsApi.delete_skill",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillsApi#delete_skill\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Skill]
    def get_skill(id, opts = {})
      data, _status_code, _headers = get_skill_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Skill, Integer, Hash)>] Skill data, response status code and response headers
    def get_skill_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillsApi.get_skill ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SkillsApi.get_skill"
      end
      # resource path
      local_var_path = '/skills/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillsApi#get_skill\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<Integer>] :id Ids of the Skills you want to retrieve
    # @option opts [String] :query A query to be used for string matching against name of Skills
    ...
    # @return [PageableSkill]
    def get_skills(opts = {})
      data, _status_code, _headers = get_skills_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :offset Skip over a number of elements by specifying an offset value for the query (default to 0)
    # @option opts [Integer] :limit Limit the number of elements on the response (default to 50)
    # @return [Array<(PageableSkill, Integer, Hash)>] PageableSkill data, response status code and response headers
    def get_skills_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillsApi.get_skills ...'
      end
      # resource path
      local_var_path = '/skills'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PageableSkill'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SkillsApi.get_skills",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillsApi#get_skills\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [SkillInput] :skill_input 
    # @return [Skill]
    def update_skill(id, opts = {})
      data, _status_code, _headers = update_skill_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [SkillInput] :skill_input 
    # @return [Array<(Skill, Integer, Hash)>] Skill data, response status code and response headers
    def update_skill_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillsApi.update_skill ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SkillsApi.update_skill"
      end
      # resource path
      local_var_path = '/skills/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SkillsApi.update_skill",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillsApi#update_skill\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
