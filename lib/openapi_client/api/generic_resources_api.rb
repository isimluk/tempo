...
module OpenapiClient
  class GenericResourcesApi
    ...
    # @option opts [GenericResourceInput] :generic_resource_input 
    # @return [GenericResource]
    def create_generic_resource(opts = {})
      data, _status_code, _headers = create_generic_resource_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [GenericResourceInput] :generic_resource_input 
    # @return [Array<(GenericResource, Integer, Hash)>] GenericResource data, response status code and response headers
    def create_generic_resource_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GenericResourcesApi.create_generic_resource ...'
      end
      # resource path
      local_var_path = '/generic-resources'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'generic_resource_input'])

      # return_type
      return_type = opts[:debug_return_type] || 'GenericResource'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"GenericResourcesApi.create_generic_resource",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GenericResourcesApi#create_generic_resource\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [Integer] An id that uniquely identifies the Generic Resource
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_generic_resource(id, opts = {})
      delete_generic_resource_with_http_info(id, opts)
      nil
    end
    ...
    def delete_generic_resource_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GenericResourcesApi.delete_generic_resource ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling GenericResourcesApi.delete_generic_resource"
      end
      # resource path
      local_var_path = '/generic-resources/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"GenericResourcesApi.delete_generic_resource",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GenericResourcesApi#delete_generic_resource\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [GenericResourceInput] :generic_resource_input 
    # @return [GenericResource]
    def edit_generic_resource(id, opts = {})
      data, _status_code, _headers = edit_generic_resource_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [GenericResourceInput] :generic_resource_input 
    # @return [Array<(GenericResource, Integer, Hash)>] GenericResource data, response status code and response headers
    def edit_generic_resource_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GenericResourcesApi.edit_generic_resource ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling GenericResourcesApi.edit_generic_resource"
      end
      # resource path
      local_var_path = '/generic-resources/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"GenericResourcesApi.edit_generic_resource",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GenericResourcesApi#edit_generic_resource\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GenericResource]
    def get_generic_resource(id, opts = {})
      data, _status_code, _headers = get_generic_resource_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GenericResource, Integer, Hash)>] GenericResource data, response status code and response headers
    def get_generic_resource_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GenericResourcesApi.get_generic_resource ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling GenericResourcesApi.get_generic_resource"
      end
      # resource path
      local_var_path = '/generic-resources/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"GenericResourcesApi.get_generic_resource",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GenericResourcesApi#get_generic_resource\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [GenericResourceSearchInput] :generic_resource_search_input 
    # @return [PageableGenericResourceWithoutSelfLink]
    def search_generic_resources(opts = {})
      data, _status_code, _headers = search_generic_resources_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [GenericResourceSearchInput] :generic_resource_search_input 
    # @return [Array<(PageableGenericResourceWithoutSelfLink, Integer, Hash)>] PageableGenericResourceWithoutSelfLink data, response status code and response headers
    def search_generic_resources_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GenericResourcesApi.search_generic_resources ...'
      end
      # resource path
      local_var_path = '/generic-resources/search'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'generic_resource_search_input'])

      # return_type
      return_type = opts[:debug_return_type] || 'PageableGenericResourceWithoutSelfLink'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"GenericResourcesApi.search_generic_resources",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GenericResourcesApi#search_generic_resources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
