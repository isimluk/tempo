...
module OpenapiClient
  class ProgramApi
    ...
    # @option opts [ProgramInput] :program_input 
    # @return [Program]
    ...
    def create_program_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'program_input'])
    ...
    def get_programs(opts = {})
      data, _status_code, _headers = get_programs_with_http_info(opts)
      data
    end
    ...
    def get_programs_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramApi.get_programs ...'
      end
      # resource path
      local_var_path = '/programs'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ProgramResults'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ProgramApi.get_programs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramApi#get_programs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] 
    # @param [Hash] opts the optional parameters
    # @return [TeamRefResults]
    def get_teams_by_program_id(id, opts = {})
      data, _status_code, _headers = get_teams_by_program_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TeamRefResults, Integer, Hash)>] TeamRefResults data, response status code and response headers
    def get_teams_by_program_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramApi.get_teams_by_program_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramApi.get_teams_by_program_id"
      end
      # resource path
      local_var_path = '/programs/{id}/teams'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TeamRefResults'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ProgramApi.get_teams_by_program_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramApi#get_teams_by_program_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [ProgramInput] :program_input 
    # @return [Program]
    def update_program(id, opts = {})
      data, _status_code, _headers = update_program_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [ProgramInput] :program_input 
    # @return [Array<(Program, Integer, Hash)>] Program data, response status code and response headers
    def update_program_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProgramApi.update_program ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProgramApi.update_program"
      end
      # resource path
      local_var_path = '/programs/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ProgramApi.update_program",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProgramApi#update_program\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
