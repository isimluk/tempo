...
module OpenapiClient
  class AccountCategoriesApi
    ...
    # @option opts [CategoryInput] :category_input 
    # @return [Category]
    ...
    def create_category_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountCategoriesApi.create_category ...'
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'category_input'])
      ...
      new_options = opts.merge(
        :operation => :"AccountCategoriesApi.create_category",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountCategoriesApi#create_category\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_category(key, opts = {})
      delete_category_with_http_info(key, opts)
      nil
    end
    ...
    def delete_category_with_http_info(key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountCategoriesApi.delete_category ...'
      end
      # verify the required parameter 'key' is set
      if @api_client.config.client_side_validation && key.nil?
        fail ArgumentError, "Missing the required parameter 'key' when calling AccountCategoriesApi.delete_category"
      end
      # resource path
      local_var_path = '/account-categories/{key}'.sub('{' + 'key' + '}', CGI.escape(key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountCategoriesApi.delete_category",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountCategoriesApi#delete_category\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :id 
    # @return [Array<(CategoryResults, Integer, Hash)>] CategoryResults data, response status code and response headers
    def get_categories_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountCategoriesApi.get_categories ...'
      end
      # resource path
      local_var_path = '/account-categories'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CategoryResults'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountCategoriesApi.get_categories",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountCategoriesApi#get_categories\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Category]
    def get_category_by_key(key, opts = {})
      data, _status_code, _headers = get_category_by_key_with_http_info(key, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Category, Integer, Hash)>] Category data, response status code and response headers
    def get_category_by_key_with_http_info(key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountCategoriesApi.get_category_by_key ...'
      end
      # verify the required parameter 'key' is set
      if @api_client.config.client_side_validation && key.nil?
        fail ArgumentError, "Missing the required parameter 'key' when calling AccountCategoriesApi.get_category_by_key"
      end
      # resource path
      local_var_path = '/account-categories/{key}'.sub('{' + 'key' + '}', CGI.escape(key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountCategoriesApi.get_category_by_key",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountCategoriesApi#get_category_by_key\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param key [String] A set of characters that uniquely identify the category to be updated
    # @param [Hash] opts the optional parameters
    # @option opts [CategoryInput] :category_input 
    # @return [Category]
    def update_category(key, opts = {})
      data, _status_code, _headers = update_category_with_http_info(key, opts)
      data
    end
    ...
    # @option opts [CategoryInput] :category_input 
    # @return [Array<(Category, Integer, Hash)>] Category data, response status code and response headers
    def update_category_with_http_info(key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountCategoriesApi.update_category ...'
      end
      # verify the required parameter 'key' is set
      if @api_client.config.client_side_validation && key.nil?
        fail ArgumentError, "Missing the required parameter 'key' when calling AccountCategoriesApi.update_category"
      end
      # resource path
      local_var_path = '/account-categories/{key}'.sub('{' + 'key' + '}', CGI.escape(key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountCategoriesApi.update_category",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountCategoriesApi#update_category\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
