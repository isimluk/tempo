...
module OpenapiClient
  class WorkloadSchemesApi
    ...
    # @option opts [WorkloadSchemeInput] :workload_scheme_input 
    # @return [WorkloadScheme]
    def create_workload_scheme(opts = {})
      data, _status_code, _headers = create_workload_scheme_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [WorkloadSchemeInput] :workload_scheme_input 
    # @return [Array<(WorkloadScheme, Integer, Hash)>] WorkloadScheme data, response status code and response headers
    def create_workload_scheme_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.create_workload_scheme ...'
      end
      # resource path
      local_var_path = '/workload-schemes'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'workload_scheme_input'])

      # return_type
      return_type = opts[:debug_return_type] || 'WorkloadScheme'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.create_workload_scheme",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#create_workload_scheme\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] ID of the workload scheme
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_workload_scheme(id, opts = {})
      delete_workload_scheme_with_http_info(id, opts)
      nil
    end
    ...
    def delete_workload_scheme_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.delete_workload_scheme ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkloadSchemesApi.delete_workload_scheme"
      end
      # resource path
      local_var_path = '/workload-schemes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.delete_workload_scheme",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#delete_workload_scheme\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [WorkloadScheme]
    def get_user_workload_scheme(account_id, opts = {})
      data, _status_code, _headers = get_user_workload_scheme_with_http_info(account_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkloadScheme, Integer, Hash)>] WorkloadScheme data, response status code and response headers
    def get_user_workload_scheme_with_http_info(account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.get_user_workload_scheme ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling WorkloadSchemesApi.get_user_workload_scheme"
      end
      # resource path
      local_var_path = '/workload-schemes/users/{accountId}'.sub('{' + 'accountId' + '}', CGI.escape(account_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.get_user_workload_scheme",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#get_user_workload_scheme\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [WorkloadScheme]
    def get_workload_scheme_by_id(id, opts = {})
      data, _status_code, _headers = get_workload_scheme_by_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkloadScheme, Integer, Hash)>] WorkloadScheme data, response status code and response headers
    def get_workload_scheme_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.get_workload_scheme_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkloadSchemesApi.get_workload_scheme_by_id"
      end
      # resource path
      local_var_path = '/workload-schemes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.get_workload_scheme_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#get_workload_scheme_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [PageableUser]
    def get_workload_scheme_members1(id, opts = {})
      data, _status_code, _headers = get_workload_scheme_members1_with_http_info(id, opts)
      data
    end
    ...
    def get_workload_scheme_members1_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.get_workload_scheme_members1 ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkloadSchemesApi.get_workload_scheme_members1"
      end
      # resource path
      local_var_path = '/workload-schemes/{id}/members'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.get_workload_scheme_members1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#get_workload_scheme_members1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :offset Skip over a number of elements by specifying an offset value for the query (default to 0)
    # @option opts [Integer] :limit Limit the number of elements on the response (default to 50)
    # @return [PageableWorkloadScheme]
    def get_workload_schemes(opts = {})
      data, _status_code, _headers = get_workload_schemes_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :offset Skip over a number of elements by specifying an offset value for the query (default to 0)
    # @option opts [Integer] :limit Limit the number of elements on the response (default to 50)
    # @return [Array<(PageableWorkloadScheme, Integer, Hash)>] PageableWorkloadScheme data, response status code and response headers
    def get_workload_schemes_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.get_workload_schemes ...'
      end
      # resource path
      local_var_path = '/workload-schemes'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PageableWorkloadScheme'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.get_workload_schemes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#get_workload_schemes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [WorkloadScheme]
    def set_default_workload_scheme(id, opts = {})
      data, _status_code, _headers = set_default_workload_scheme_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkloadScheme, Integer, Hash)>] WorkloadScheme data, response status code and response headers
    def set_default_workload_scheme_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.set_default_workload_scheme ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkloadSchemesApi.set_default_workload_scheme"
      end
      # resource path
      local_var_path = '/workload-schemes/{id}/default'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.set_default_workload_scheme",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#set_default_workload_scheme\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] ID of the workload scheme
    # @param [Hash] opts the optional parameters
    # @option opts [WorkloadSchemeMembersInput] :workload_scheme_members_input 
    # @return [nil]
    def set_workload_scheme_for_users(id, opts = {})
      set_workload_scheme_for_users_with_http_info(id, opts)
      nil
    end
    ...
    # @option opts [WorkloadSchemeMembersInput] :workload_scheme_members_input 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def set_workload_scheme_for_users_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.set_workload_scheme_for_users ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkloadSchemesApi.set_workload_scheme_for_users"
      end
      # resource path
      local_var_path = '/workload-schemes/{id}/members'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'workload_scheme_members_input'])
      ...
      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.set_workload_scheme_for_users",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#set_workload_scheme_for_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [WorkloadSchemeInput] :workload_scheme_input 
    # @return [WorkloadScheme]
    def update_workload_scheme(id, opts = {})
      data, _status_code, _headers = update_workload_scheme_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [WorkloadSchemeInput] :workload_scheme_input 
    # @return [Array<(WorkloadScheme, Integer, Hash)>] WorkloadScheme data, response status code and response headers
    def update_workload_scheme_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkloadSchemesApi.update_workload_scheme ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkloadSchemesApi.update_workload_scheme"
      end
      # resource path
      local_var_path = '/workload-schemes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkloadSchemesApi.update_workload_scheme",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkloadSchemesApi#update_workload_scheme\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
