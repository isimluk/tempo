...
module OpenapiClient
  class TeamLinksApi
    ...
    # @option opts [TeamLinkInput] :team_link_input 
    # @return [TeamLink]
    def create_team_link(opts = {})
      data, _status_code, _headers = create_team_link_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [TeamLinkInput] :team_link_input 
    # @return [Array<(TeamLink, Integer, Hash)>] TeamLink data, response status code and response headers
    def create_team_link_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamLinksApi.create_team_link ...'
      end
      # resource path
      local_var_path = '/team-links'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'team_link_input'])

      # return_type
      return_type = opts[:debug_return_type] || 'TeamLink'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TeamLinksApi.create_team_link",
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_team_link(link_id, opts = {})
      delete_team_link_with_http_info(link_id, opts)
      nil
    end
    ...
    def delete_team_link_with_http_info(link_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamLinksApi.delete_team_link ...'
      end
      # verify the required parameter 'link_id' is set
      if @api_client.config.client_side_validation && link_id.nil?
        fail ArgumentError, "Missing the required parameter 'link_id' when calling TeamLinksApi.delete_team_link"
      end
      # resource path
      local_var_path = '/team-links/{linkId}'.sub('{' + 'linkId' + '}', CGI.escape(link_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TeamLinksApi.delete_team_link",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeamLinksApi#delete_team_link\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [TeamLink]
    def get_team_link(link_id, opts = {})
      data, _status_code, _headers = get_team_link_with_http_info(link_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(TeamLink, Integer, Hash)>] TeamLink data, response status code and response headers
    def get_team_link_with_http_info(link_id, opts = {})
      if @api_client.config.debugging
      ...
      new_options = opts.merge(
        :operation => :"TeamLinksApi.get_team_link",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [TeamLinkResults]
    def get_team_link_by_project_id(id, opts = {})
      data, _status_code, _headers = get_team_link_by_project_id_with_http_info(id, opts)
      data
    end
    ...
    # @param id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TeamLinkResults, Integer, Hash)>] TeamLinkResults data, response status code and response headers
    def get_team_link_by_project_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamLinksApi.get_team_link_by_project_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeamLinksApi.get_team_link_by_project_id"
      end
      # resource path
      local_var_path = '/team-links/project/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TeamLinkResults'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TeamLinksApi.get_team_link_by_project_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeamLinksApi#get_team_link_by_project_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
