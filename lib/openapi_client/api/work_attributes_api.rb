...
module OpenapiClient
  class WorkAttributesApi
    ...
    # @option opts [CreateWorkAttributeInput] :create_work_attribute_input 
    # @return [WorkAttribute]
    def create_work_attributes(opts = {})
      data, _status_code, _headers = create_work_attributes_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [CreateWorkAttributeInput] :create_work_attribute_input 
    # @return [Array<(WorkAttribute, Integer, Hash)>] WorkAttribute data, response status code and response headers
    def create_work_attributes_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkAttributesApi.create_work_attributes ...'
      end
      # resource path
      local_var_path = '/work-attributes'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'create_work_attribute_input'])

      # return_type
      return_type = opts[:debug_return_type] || 'WorkAttribute'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"WorkAttributesApi.create_work_attributes",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkAttributesApi#create_work_attributes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_work_attribute_by_key(key, opts = {})
      delete_work_attribute_by_key_with_http_info(key, opts)
      nil
    end
    ...
    def delete_work_attribute_by_key_with_http_info(key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkAttributesApi.delete_work_attribute_by_key ...'
      end
      # verify the required parameter 'key' is set
      if @api_client.config.client_side_validation && key.nil?
        fail ArgumentError, "Missing the required parameter 'key' when calling WorkAttributesApi.delete_work_attribute_by_key"
      end
      # resource path
      local_var_path = '/work-attributes/{key}'.sub('{' + 'key' + '}', CGI.escape(key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkAttributesApi.delete_work_attribute_by_key",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkAttributesApi#delete_work_attribute_by_key\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [WorkAttribute]
    def get_work_attribute_by_key(key, opts = {})
      data, _status_code, _headers = get_work_attribute_by_key_with_http_info(key, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkAttribute, Integer, Hash)>] WorkAttribute data, response status code and response headers
    def get_work_attribute_by_key_with_http_info(key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkAttributesApi.get_work_attribute_by_key ...'
      end
      # verify the required parameter 'key' is set
      if @api_client.config.client_side_validation && key.nil?
        fail ArgumentError, "Missing the required parameter 'key' when calling WorkAttributesApi.get_work_attribute_by_key"
      end
      # resource path
      local_var_path = '/work-attributes/{key}'.sub('{' + 'key' + '}', CGI.escape(key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkAttributesApi.get_work_attribute_by_key",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkAttributesApi#get_work_attribute_by_key\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [PageableWorkAttribute]
    def get_work_attributes(opts = {})
      data, _status_code, _headers = get_work_attributes_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :offset Skip over a number of elements by specifying an offset value for the query (default to 0)
    # @option opts [Integer] :limit Limit the number of elements on the response (default to 50)
    # @return [Array<(PageableWorkAttribute, Integer, Hash)>] PageableWorkAttribute data, response status code and response headers
    def get_work_attributes_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkAttributesApi.get_work_attributes ...'
      end
      # resource path
      local_var_path = '/work-attributes'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PageableWorkAttribute'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"WorkAttributesApi.get_work_attributes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkAttributesApi#get_work_attributes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [UpdateWorkAttributeInput] :update_work_attribute_input 
    # @return [WorkAttribute]
    def update_work_attribute_by_key(key, opts = {})
      data, _status_code, _headers = update_work_attribute_by_key_with_http_info(key, opts)
      data
    end
    ...
    # @option opts [UpdateWorkAttributeInput] :update_work_attribute_input 
    # @return [Array<(WorkAttribute, Integer, Hash)>] WorkAttribute data, response status code and response headers
    def update_work_attribute_by_key_with_http_info(key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkAttributesApi.update_work_attribute_by_key ...'
      end
      # verify the required parameter 'key' is set
      if @api_client.config.client_side_validation && key.nil?
        fail ArgumentError, "Missing the required parameter 'key' when calling WorkAttributesApi.update_work_attribute_by_key"
      end
      # resource path
      local_var_path = '/work-attributes/{key}'.sub('{' + 'key' + '}', CGI.escape(key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'update_work_attribute_input'])
      ...
      new_options = opts.merge(
        :operation => :"WorkAttributesApi.update_work_attribute_by_key",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkAttributesApi#update_work_attribute_by_key\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
