...
module OpenapiClient
  class UserScheduleApi
    ...
    # @param to [String] The end date in format yyyy-mm-dd
    # @param [Hash] opts the optional parameters
    # @return [DayScheduleResults]
    def get_authenticated_user_schedule(from, to, opts = {})
      data, _status_code, _headers = get_authenticated_user_schedule_with_http_info(from, to, opts)
      data
    end
    ...
    # @param to [String] The end date in format yyyy-mm-dd
    # @param [Hash] opts the optional parameters
    # @return [Array<(DayScheduleResults, Integer, Hash)>] DayScheduleResults data, response status code and response headers
    def get_authenticated_user_schedule_with_http_info(from, to, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserScheduleApi.get_authenticated_user_schedule ...'
      end
      # verify the required parameter 'from' is set
      if @api_client.config.client_side_validation && from.nil?
        fail ArgumentError, "Missing the required parameter 'from' when calling UserScheduleApi.get_authenticated_user_schedule"
      end
      # verify the required parameter 'to' is set
      if @api_client.config.client_side_validation && to.nil?
        fail ArgumentError, "Missing the required parameter 'to' when calling UserScheduleApi.get_authenticated_user_schedule"
      end
      # resource path
      local_var_path = '/user-schedule'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DayScheduleResults'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"UserScheduleApi.get_authenticated_user_schedule",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserScheduleApi#get_authenticated_user_schedule\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [DayScheduleResults]
    def get_user_schedule(account_id, from, to, opts = {})
      data, _status_code, _headers = get_user_schedule_with_http_info(account_id, from, to, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(DayScheduleResults, Integer, Hash)>] DayScheduleResults data, response status code and response headers
    def get_user_schedule_with_http_info(account_id, from, to, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserScheduleApi.get_user_schedule ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling UserScheduleApi.get_user_schedule"
      end
      # verify the required parameter 'from' is set
      if @api_client.config.client_side_validation && from.nil?
        fail ArgumentError, "Missing the required parameter 'from' when calling UserScheduleApi.get_user_schedule"
      end
      # verify the required parameter 'to' is set
      if @api_client.config.client_side_validation && to.nil?
        fail ArgumentError, "Missing the required parameter 'to' when calling UserScheduleApi.get_user_schedule"
      end
      # resource path
      local_var_path = '/user-schedule/{accountId}'.sub('{' + 'accountId' + '}', CGI.escape(account_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UserScheduleApi.get_user_schedule",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserScheduleApi#get_user_schedule\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
