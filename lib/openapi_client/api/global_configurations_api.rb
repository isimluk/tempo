...
module OpenapiClient
  class GlobalConfigurationsApi
    ...
    def get_global_configuration(opts = {})
      data, _status_code, _headers = get_global_configuration_with_http_info(opts)
      data
    end
    ...
    # Retrieves the Global Configurations
    # @param [Hash] opts the optional parameters
    # @return [Array<(GlobalConfiguration, Integer, Hash)>] GlobalConfiguration data, response status code and response headers
    def get_global_configuration_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GlobalConfigurationsApi.get_global_configuration ...'
      end
      # resource path
      local_var_path = '/globalconfiguration'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GlobalConfiguration'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"GlobalConfigurationsApi.get_global_configuration",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobalConfigurationsApi#get_global_configuration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
