...
module OpenapiClient
  class TimesheetApprovalsApi
    ...
    # @param from [String] The Start Date in format yyyy-mm-dd
    ...
    def approve_timesheet_for_user(account_id, from, opts = {})
      data, _status_code, _headers = approve_timesheet_for_user_with_http_info(account_id, from, opts)
      data
    end
    ...
    # @option opts [String] :to The End Date in format yyyy-mm-dd
    # @option opts [TimesheetApprovalInput] :timesheet_approval_input 
    # @return [Array<(TimesheetApproval, Integer, Hash)>] TimesheetApproval data, response status code and response headers
    def approve_timesheet_for_user_with_http_info(account_id, from, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimesheetApprovalsApi.approve_timesheet_for_user ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TimesheetApprovalsApi.approve_timesheet_for_user"
      end
      # verify the required parameter 'from' is set
      if @api_client.config.client_side_validation && from.nil?
        fail ArgumentError, "Missing the required parameter 'from' when calling TimesheetApprovalsApi.approve_timesheet_for_user"
      end
      # resource path
      local_var_path = '/timesheet-approvals/user/{accountId}/approve'.sub('{' + 'accountId' + '}', CGI.escape(account_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'timesheet_approval_input'])

      # return_type
      return_type = opts[:debug_return_type] || 'TimesheetApproval'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TimesheetApprovalsApi.approve_timesheet_for_user",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimesheetApprovalsApi#approve_timesheet_for_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_timesheet_approval_for_team(team_id, from, opts = {})
      data, _status_code, _headers = get_timesheet_approval_for_team_with_http_info(team_id, from, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :to The End Date in format yyyy-mm-dd
    # @return [Array<(TimesheetApprovalResults, Integer, Hash)>] TimesheetApprovalResults data, response status code and response headers
    def get_timesheet_approval_for_team_with_http_info(team_id, from, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimesheetApprovalsApi.get_timesheet_approval_for_team ...'
      end
      # verify the required parameter 'team_id' is set
      if @api_client.config.client_side_validation && team_id.nil?
        fail ArgumentError, "Missing the required parameter 'team_id' when calling TimesheetApprovalsApi.get_timesheet_approval_for_team"
      end
      # verify the required parameter 'from' is set
      if @api_client.config.client_side_validation && from.nil?
        fail ArgumentError, "Missing the required parameter 'from' when calling TimesheetApprovalsApi.get_timesheet_approval_for_team"
      end
      # resource path
      local_var_path = '/timesheet-approvals/team/{teamId}'.sub('{' + 'teamId' + '}', CGI.escape(team_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TimesheetApprovalResults'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TimesheetApprovalsApi.get_timesheet_approval_for_team",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimesheetApprovalsApi#get_timesheet_approval_for_team\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :to The End Date in format yyyy-mm-dd
    # @return [TimesheetApproval]
    def get_timesheet_approval_for_user(account_id, from, opts = {})
      data, _status_code, _headers = get_timesheet_approval_for_user_with_http_info(account_id, from, opts)
      data
    end
    ...
    # @option opts [String] :to The End Date in format yyyy-mm-dd
    # @return [Array<(TimesheetApproval, Integer, Hash)>] TimesheetApproval data, response status code and response headers
    def get_timesheet_approval_for_user_with_http_info(account_id, from, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimesheetApprovalsApi.get_timesheet_approval_for_user ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TimesheetApprovalsApi.get_timesheet_approval_for_user"
      end
      # verify the required parameter 'from' is set
      if @api_client.config.client_side_validation && from.nil?
        fail ArgumentError, "Missing the required parameter 'from' when calling TimesheetApprovalsApi.get_timesheet_approval_for_user"
      end
      # resource path
      local_var_path = '/timesheet-approvals/user/{accountId}'.sub('{' + 'accountId' + '}', CGI.escape(account_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TimesheetApprovalsApi.get_timesheet_approval_for_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimesheetApprovalsApi#get_timesheet_approval_for_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [TimesheetApprovalResults]
    def get_timesheet_approvals_waiting_for_approval(opts = {})
      data, _status_code, _headers = get_timesheet_approvals_waiting_for_approval_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(TimesheetApprovalResults, Integer, Hash)>] TimesheetApprovalResults data, response status code and response headers
    def get_timesheet_approvals_waiting_for_approval_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimesheetApprovalsApi.get_timesheet_approvals_waiting_for_approval ...'
      end
      # resource path
      local_var_path = '/timesheet-approvals/waiting'
      ...
      new_options = opts.merge(
        :operation => :"TimesheetApprovalsApi.get_timesheet_approvals_waiting_for_approval",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimesheetApprovalsApi#get_timesheet_approvals_waiting_for_approval\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [UserResults]
    def get_timesheet_reviewers_for_user(account_id, opts = {})
      data, _status_code, _headers = get_timesheet_reviewers_for_user_with_http_info(account_id, opts)
      data
    end
    ...
    def get_timesheet_reviewers_for_user_with_http_info(account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimesheetApprovalsApi.get_timesheet_reviewers_for_user ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TimesheetApprovalsApi.get_timesheet_reviewers_for_user"
      end
      # resource path
      local_var_path = '/timesheet-approvals/user/{accountId}/reviewers'.sub('{' + 'accountId' + '}', CGI.escape(account_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UserResults'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TimesheetApprovalsApi.get_timesheet_reviewers_for_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimesheetApprovalsApi#get_timesheet_reviewers_for_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [TimesheetApprovalInput] :timesheet_approval_input 
    # @return [TimesheetApproval]
    def reject_timesheet_for_user(account_id, from, opts = {})
      data, _status_code, _headers = reject_timesheet_for_user_with_http_info(account_id, from, opts)
      data
    end
    ...
    # @option opts [TimesheetApprovalInput] :timesheet_approval_input 
    # @return [Array<(TimesheetApproval, Integer, Hash)>] TimesheetApproval data, response status code and response headers
    def reject_timesheet_for_user_with_http_info(account_id, from, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimesheetApprovalsApi.reject_timesheet_for_user ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TimesheetApprovalsApi.reject_timesheet_for_user"
      end
      # verify the required parameter 'from' is set
      if @api_client.config.client_side_validation && from.nil?
        fail ArgumentError, "Missing the required parameter 'from' when calling TimesheetApprovalsApi.reject_timesheet_for_user"
      end
      # resource path
      local_var_path = '/timesheet-approvals/user/{accountId}/reject'.sub('{' + 'accountId' + '}', CGI.escape(account_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TimesheetApprovalsApi.reject_timesheet_for_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimesheetApprovalsApi#reject_timesheet_for_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [TimesheetApprovalInput] :timesheet_approval_input 
    # @return [TimesheetApproval]
    def reopen_timesheet_for_user(account_id, from, opts = {})
      data, _status_code, _headers = reopen_timesheet_for_user_with_http_info(account_id, from, opts)
      data
    end
    ...
    # @option opts [TimesheetApprovalInput] :timesheet_approval_input 
    # @return [Array<(TimesheetApproval, Integer, Hash)>] TimesheetApproval data, response status code and response headers
    def reopen_timesheet_for_user_with_http_info(account_id, from, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimesheetApprovalsApi.reopen_timesheet_for_user ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TimesheetApprovalsApi.reopen_timesheet_for_user"
      end
      # verify the required parameter 'from' is set
      if @api_client.config.client_side_validation && from.nil?
        fail ArgumentError, "Missing the required parameter 'from' when calling TimesheetApprovalsApi.reopen_timesheet_for_user"
      end
      # resource path
      local_var_path = '/timesheet-approvals/user/{accountId}/reopen'.sub('{' + 'accountId' + '}', CGI.escape(account_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TimesheetApprovalsApi.reopen_timesheet_for_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimesheetApprovalsApi#reopen_timesheet_for_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [TimesheetApprovalInput] :timesheet_approval_input 
    # @return [TimesheetApproval]
    def submit_timesheet_for_user(account_id, from, opts = {})
      data, _status_code, _headers = submit_timesheet_for_user_with_http_info(account_id, from, opts)
      data
    end
    ...
    # @option opts [TimesheetApprovalInput] :timesheet_approval_input 
    # @return [Array<(TimesheetApproval, Integer, Hash)>] TimesheetApproval data, response status code and response headers
    def submit_timesheet_for_user_with_http_info(account_id, from, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimesheetApprovalsApi.submit_timesheet_for_user ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TimesheetApprovalsApi.submit_timesheet_for_user"
      end
      # verify the required parameter 'from' is set
      if @api_client.config.client_side_validation && from.nil?
        fail ArgumentError, "Missing the required parameter 'from' when calling TimesheetApprovalsApi.submit_timesheet_for_user"
      end
      # resource path
      local_var_path = '/timesheet-approvals/user/{accountId}/submit'.sub('{' + 'accountId' + '}', CGI.escape(account_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TimesheetApprovalsApi.submit_timesheet_for_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimesheetApprovalsApi#submit_timesheet_for_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
