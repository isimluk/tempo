...
module OpenapiClient
  class SkillAssignmentsApi
    ...
    # @option opts [SkillsAssignmentInput] :skills_assignment_input 
    # @return [Array<Skill>]
    def assign_skills(opts = {})
      data, _status_code, _headers = assign_skills_with_http_info(opts)
      data
    end
    ...
    def assign_skills_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillAssignmentsApi.assign_skills ...'
      end
      # resource path
      local_var_path = '/skill-assignments'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'skills_assignment_input'])
      ...
      new_options = opts.merge(
        :operation => :"SkillAssignmentsApi.assign_skills",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillAssignmentsApi#assign_skills\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param assignee_id [String] A string that uniquely identifies the resource
    # @param assignee_type [String] A string that identifies the resource type, which can be USER or GENERIC
    # @param [Hash] opts the optional parameters
    # @return [Array<Skill>]
    def get_skill_assignments(assignee_id, assignee_type, opts = {})
      data, _status_code, _headers = get_skill_assignments_with_http_info(assignee_id, assignee_type, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<Skill>, Integer, Hash)>] Array<Skill> data, response status code and response headers
    def get_skill_assignments_with_http_info(assignee_id, assignee_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillAssignmentsApi.get_skill_assignments ...'
      end
      # verify the required parameter 'assignee_id' is set
      if @api_client.config.client_side_validation && assignee_id.nil?
        fail ArgumentError, "Missing the required parameter 'assignee_id' when calling SkillAssignmentsApi.get_skill_assignments"
      end
      # verify the required parameter 'assignee_type' is set
      if @api_client.config.client_side_validation && assignee_type.nil?
        fail ArgumentError, "Missing the required parameter 'assignee_type' when calling SkillAssignmentsApi.get_skill_assignments"
      end
      # resource path
      local_var_path = '/skill-assignments/{assigneeId}/{assigneeType}'.sub('{' + 'assigneeId' + '}', CGI.escape(assignee_id.to_s)).sub('{' + 'assigneeType' + '}', CGI.escape(assignee_type.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SkillAssignmentsApi.get_skill_assignments",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillAssignmentsApi#get_skill_assignments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param assignee_id [String] A string that uniquely identifies the resource
    # @param assignee_type [String] A string that identifies the resource type, which can be USER or GENERIC
    # @param skill_id [Integer] An id that uniquely identify the Skill
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def remove_skill_assignment(assignee_id, assignee_type, skill_id, opts = {})
      remove_skill_assignment_with_http_info(assignee_id, assignee_type, skill_id, opts)
      nil
    end
    ...
    def remove_skill_assignment_with_http_info(assignee_id, assignee_type, skill_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillAssignmentsApi.remove_skill_assignment ...'
      end
      # verify the required parameter 'assignee_id' is set
      if @api_client.config.client_side_validation && assignee_id.nil?
        fail ArgumentError, "Missing the required parameter 'assignee_id' when calling SkillAssignmentsApi.remove_skill_assignment"
      end
      # verify the required parameter 'assignee_type' is set
      if @api_client.config.client_side_validation && assignee_type.nil?
        fail ArgumentError, "Missing the required parameter 'assignee_type' when calling SkillAssignmentsApi.remove_skill_assignment"
      end
      # verify the required parameter 'skill_id' is set
      if @api_client.config.client_side_validation && skill_id.nil?
        fail ArgumentError, "Missing the required parameter 'skill_id' when calling SkillAssignmentsApi.remove_skill_assignment"
      end
      # resource path
      local_var_path = '/skill-assignments/{assigneeId}/{assigneeType}/{skillId}'.sub('{' + 'assigneeId' + '}', CGI.escape(assignee_id.to_s)).sub('{' + 'assigneeType' + '}', CGI.escape(assignee_type.to_s)).sub('{' + 'skillId' + '}', CGI.escape(skill_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SkillAssignmentsApi.remove_skill_assignment",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillAssignmentsApi#remove_skill_assignment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [SkillsAssignmentInput] :skills_assignment_input 
    # @return [Array<Skill>]
    def replace_skill_assignments(opts = {})
      data, _status_code, _headers = replace_skill_assignments_with_http_info(opts)
      data
    end
    ...
    # @option opts [SkillsAssignmentInput] :skills_assignment_input 
    # @return [Array<(Array<Skill>, Integer, Hash)>] Array<Skill> data, response status code and response headers
    def replace_skill_assignments_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SkillAssignmentsApi.replace_skill_assignments ...'
      end
      # resource path
      local_var_path = '/skill-assignments/replace'
      ...
      new_options = opts.merge(
        :operation => :"SkillAssignmentsApi.replace_skill_assignments",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SkillAssignmentsApi#replace_skill_assignments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
