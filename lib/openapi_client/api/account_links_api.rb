...
module OpenapiClient
  class AccountLinksApi
    ...
    # @option opts [AccountLinkInput] :account_link_input 
    # @return [AccountLink]
    ...
    def create_link_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountLinksApi.create_link ...'
      end
      # resource path
      local_var_path = '/account-links'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'account_link_input'])

      # return_type
      return_type = opts[:debug_return_type] || 'AccountLink'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountLinksApi.create_link",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountLinksApi#create_link\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [Integer] An integer uniquely identifying the &#x60;AccountLink&#x60;
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def delete_link_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountLinksApi.delete_link ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountLinksApi.delete_link"
      end
      # resource path
      local_var_path = '/account-links/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountLinksApi.delete_link",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountLinksApi#delete_link\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_link_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountLinksApi.get_link ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountLinksApi.get_link"
      end
      # resource path
      local_var_path = '/account-links/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountLinksApi.get_link",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountLinksApi#get_link\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [AccountLinkResults]
    def get_links_by_project(id, opts = {})
      data, _status_code, _headers = get_links_by_project_with_http_info(id, opts)
      data
    end
    ...
    # @param id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountLinkResults, Integer, Hash)>] AccountLinkResults data, response status code and response headers
    def get_links_by_project_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountLinksApi.get_links_by_project ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountLinksApi.get_links_by_project"
      end
      # resource path
      local_var_path = '/account-links/project/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AccountLinkResults'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountLinksApi.get_links_by_project",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountLinksApi#get_links_by_project\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
