...
# Unit tests for OpenapiClient::UserScheduleApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UserScheduleApi' do
  before do
  ...
  describe 'test an instance of UserScheduleApi' do
    it 'should create an instance of UserScheduleApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::UserScheduleApi)
    end
  end

  # unit tests for get_authenticated_user_schedule
  ...
  describe 'get_authenticated_user_schedule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_user_schedule
  ...
  # @param [Hash] opts the optional parameters
  # @return [DayScheduleResults]
  describe 'get_user_schedule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
