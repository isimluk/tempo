...
# Unit tests for OpenapiClient::AccountCategoriesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountCategoriesApi' do
  before do
  ...
  describe 'test an instance of AccountCategoriesApi' do
    it 'should create an instance of AccountCategoriesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::AccountCategoriesApi)
    end
  end
  ...
  # unit tests for get_category_by_key
  # Retrieve Category
  # Retrieves an existing Category for the given key
  # @param key 
  # @param [Hash] opts the optional parameters
  # @return [Category]
  describe 'get_category_by_key test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
