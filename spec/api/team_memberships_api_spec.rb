...
# Unit tests for OpenapiClient::TeamMembershipsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TeamMembershipsApi' do
  before do
  ...
  describe 'test an instance of TeamMembershipsApi' do
    it 'should create an instance of TeamMembershipsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::TeamMembershipsApi)
    end
  end
