...
# Unit tests for OpenapiClient::WorklogsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WorklogsApi' do
  before do
  ...
  describe 'test an instance of WorklogsApi' do
    it 'should create an instance of WorklogsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::WorklogsApi)
    end
  end

  # unit tests for create_work_attribute_values_for_worklogs
  ...
  # @return [nil]
  describe 'create_work_attribute_values_for_worklogs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_worklog
  # Create Worklog
  ...
  # @return [Worklog]
  describe 'create_worklog test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_worklog
  # Delete Worklog 
  # Deletes an existing Worklog for the given id
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_worklog test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_jira_worklog_ids_by_tempo_worklog_ids
  ...
  describe 'get_jira_worklog_ids_by_tempo_worklog_ids test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_work_attribute_value_for_worklog
  ...
  describe 'get_work_attribute_value_for_worklog test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_work_attribute_values_for_worklog
  ...
  describe 'get_work_attribute_values_for_worklog test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_worklog_by_id
  # Retrieve Worklog
  # Retrieves an existing Worklog for the given id
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Worklog]
  describe 'get_worklog_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_worklogs
  # Retrieve Worklogs
  ...
  describe 'get_worklogs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_worklogs_by_account
  ...
  # @option opts [Integer] :limit Limit the number of elements on the response
  # @return [PageableWorklog]
  describe 'get_worklogs_by_account test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_worklogs_by_issue_id
  ...
  # @option opts [Integer] :limit Limit the number of elements on the response
  # @return [PageableWorklog]
  describe 'get_worklogs_by_issue_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_worklogs_by_project_id
  ...
  # @param project_id Id of the project you want to retrieve Worklogs for
  # @param [Hash] opts the optional parameters
  # @option opts [String] :from Retrieve results starting with this date
  # @option opts [String] :to Retrieve results up to and including this date
  # @option opts [String] :updated_from Retrieve results that have been updated from this date
  ...
  # @option opts [Integer] :limit Limit the number of elements on the response
  # @return [PageableWorklog]
  describe 'get_worklogs_by_project_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_worklogs_by_team
  ...
  # @option opts [Integer] :limit Limit the number of elements on the response
  # @return [PageableWorklog]
  describe 'get_worklogs_by_team test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_worklogs_by_user
  ...
  # @option opts [Integer] :limit Limit the number of elements on the response
  # @return [PageableWorklog]
  describe 'get_worklogs_by_user test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for search_worklogs
  # Search Worklogs
  ...
  # @return [PageableWorklog]
  describe 'search_worklogs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_worklog
  # Update Worklog
  ...
  # @option opts [WorklogInput] :worklog_input 
  # @return [Worklog]
  describe 'update_worklog test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
