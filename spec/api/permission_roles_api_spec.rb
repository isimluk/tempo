...
# Unit tests for OpenapiClient::PermissionRolesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PermissionRolesApi' do
  before do
  ...
  describe 'test an instance of PermissionRolesApi' do
    it 'should create an instance of PermissionRolesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::PermissionRolesApi)
    end
  end

  # unit tests for create_permission_group
  ...
  describe 'create_permission_group test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_editable_permission_group
  # Delete Permission Role
  # Deletes an editable Permission Role.
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_editable_permission_group test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_global_permission_roles
  ...
  describe 'get_global_permission_roles test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_permission_role
  # Retrieve Permission Role
  # Retrieves a Permission Role for the given id
  # @param id ID of the permission role
  # @param [Hash] opts the optional parameters
  # @return [PermissionRole]
  describe 'get_permission_role test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_permission_roles
  ...
  # @return [PageablePermissionRole]
  describe 'get_permission_roles test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_permission_group
  ...
  # @option opts [PermissionRoleInput] :permission_role_input 
  # @return [PermissionRole]
  describe 'update_permission_group test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
