...
# Unit tests for OpenapiClient::ProgramApi
...
describe 'ProgramApi' do
  ...
  describe 'test an instance of ProgramApi' do
    it 'should create an instance of ProgramApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::ProgramApi)
    end
  end
  ...
  # unit tests for delete_program
  # Delete Program
  # Deletes an existing Program for the given id
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_program test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for get_programs
  # Retrieve all Programs
  # Retrieves a list of all Programs
  # @param [Hash] opts the optional parameters
  # @return [ProgramResults]
  describe 'get_programs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_teams_by_program_id
  # Retrieve Teams associated with Program
  # Retrieves a list of Teams associated with the given Program
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [TeamRefResults]
  describe 'get_teams_by_program_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_program
  # Update Program
  ...
  # @option opts [ProgramInput] :program_input 
  # @return [Program]
  describe 'update_program test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
