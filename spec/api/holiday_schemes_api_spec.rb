...
# Unit tests for OpenapiClient::HolidaySchemesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HolidaySchemesApi' do
  before do
  ...
  describe 'test an instance of HolidaySchemesApi' do
    it 'should create an instance of HolidaySchemesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::HolidaySchemesApi)
    end
  end

  # unit tests for create_holiday
  # Add holiday
  ...
  # @return [Holiday]
  describe 'create_holiday test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_holiday_scheme
  # Add holiday scheme
  # Add holiday scheme of a given input
  # @param [Hash] opts the optional parameters
  # @option opts [HolidaySchemeInputBean] :holiday_scheme_input_bean 
  # @return [HolidayScheme]
  describe 'create_holiday_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_holiday
  # Delete holiday
  # Delete a holiday with the given id
  # @param scheme_id The id of the Scheme
  # @param holiday_id The id of the holiday
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_holiday test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_holiday_scheme
  # Delete a holiday scheme
  # Delete a holiday scheme with the given id
  # @param scheme_id The id of the Scheme
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_holiday_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_floating_holidays
  # Get floating holidays
  # List all floating holidays of a given scheme
  # @param scheme_id The id of the Scheme
  # @param [Hash] opts the optional parameters
  # @return [HolidayResults]
  describe 'get_floating_holidays test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_holiday
  # Get holiday
  # Get holiday information
  # @param scheme_id The id of the holiday scheme
  # @param holiday_id The id of the holiday
  # @param [Hash] opts the optional parameters
  # @return [Holiday]
  describe 'get_holiday test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_holiday_scheme
  # Get holiday scheme
  # Get Holiday scheme of a given scheme id
  # @param scheme_id The id of the Scheme
  # @param [Hash] opts the optional parameters
  # @return [HolidayScheme]
  describe 'get_holiday_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_holiday_schemes
  # Get holiday schemes
  # List all holiday schemes
  # @param [Hash] opts the optional parameters
  # @return [HolidaySchemeResults]
  describe 'get_holiday_schemes test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_holidays
  # Get holidays
  ...
  # @return [HolidayResults]
  describe 'get_holidays test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_user_holiday_scheme
  # Get user scheme
  # Get an user scheme with the given id
  # @param account_id A unique identifier of the user in Jira
  # @param [Hash] opts the optional parameters
  # @return [HolidayScheme]
  describe 'get_user_holiday_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_workload_scheme_members
  # Get members in a holiday scheme
  # Get holiday scheme members with the given id
  # @param scheme_id The id of the Scheme
  # @param [Hash] opts the optional parameters
  # @option opts [Integer] :offset Skip over a number of elements by specifying an offset value for the query
  # @option opts [Integer] :limit Limit the number of elements on the response
  # @return [PageableUser]
  describe 'get_workload_scheme_members test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for set_default_scheme
  # Set the default holiday scheme
  # Set the default holiday scheme
  # @param scheme_id The id of the Scheme
  # @param [Hash] opts the optional parameters
  # @return [HolidayScheme]
  describe 'set_default_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for set_workload_scheme_membership
  ...
  # @return [nil]
  describe 'set_workload_scheme_membership test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_holiday
  # Update a holiday
  ...
  # @option opts [HolidayInput] :holiday_input 
  # @return [Holiday]
  describe 'update_holiday test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_holiday_scheme
  ...
  # @option opts [HolidaySchemeInputBean] :holiday_scheme_input_bean 
  # @return [HolidayScheme]
  describe 'update_holiday_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
