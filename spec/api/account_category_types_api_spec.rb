...
# Unit tests for OpenapiClient::AccountCategoryTypesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountCategoryTypesApi' do
  before do
  ...
  describe 'test an instance of AccountCategoryTypesApi' do
    it 'should create an instance of AccountCategoryTypesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::AccountCategoryTypesApi)
    end
  end
