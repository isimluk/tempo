...
# Unit tests for OpenapiClient::SkillAssignmentsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SkillAssignmentsApi' do
  before do
  ...
  describe 'test an instance of SkillAssignmentsApi' do
    it 'should create an instance of SkillAssignmentsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::SkillAssignmentsApi)
    end
  end

  # unit tests for assign_skills
  ...
  # @return [Array<Skill>]
  describe 'assign_skills test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_skill_assignments
  # Retrieve Skill Assignments for Resource
  # Retrieves a list of Skill Assignments for the given Resource
  # @param assignee_id A string that uniquely identifies the resource
  # @param assignee_type A string that identifies the resource type, which can be USER or GENERIC
  # @param [Hash] opts the optional parameters
  # @return [Array<Skill>]
  describe 'get_skill_assignments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for remove_skill_assignment
  # Delete skill of the Resource
  # Deletes an existing Skill for the given Resource
  # @param assignee_id A string that uniquely identifies the resource
  # @param assignee_type A string that identifies the resource type, which can be USER or GENERIC
  # @param skill_id An id that uniquely identify the Skill
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'remove_skill_assignment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_skill_assignments
  ...
  # @option opts [SkillsAssignmentInput] :skills_assignment_input 
  # @return [Array<Skill>]
  describe 'replace_skill_assignments test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
