...
# Unit tests for OpenapiClient::TeamLinksApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TeamLinksApi' do
  before do
  ...
  describe 'test an instance of TeamLinksApi' do
    it 'should create an instance of TeamLinksApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::TeamLinksApi)
    end
  end

  # unit tests for create_team_link
  # Create Team Link
  ...
  # @return [TeamLink]
  describe 'create_team_link test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_team_link
  # Delete Team Link
  # Deletes an existing Team Link for the given id
  # @param link_id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_team_link test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_team_link
  # Retrieve Team Link
  # Retrieves an existing Team Link for the given id
  # @param link_id 
  # @param [Hash] opts the optional parameters
  # @return [TeamLink]
  describe 'get_team_link test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_team_link_by_project_id
  # Retrieve Team Link by Project
  # Retrieves an existing Team Link for the given Project id
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [TeamLinkResults]
  describe 'get_team_link_by_project_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
