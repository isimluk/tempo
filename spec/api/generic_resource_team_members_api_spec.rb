...
# Unit tests for OpenapiClient::GenericResourceTeamMembersApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GenericResourceTeamMembersApi' do
  before do
  ...
  describe 'test an instance of GenericResourceTeamMembersApi' do
    it 'should create an instance of GenericResourceTeamMembersApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::GenericResourceTeamMembersApi)
    end
  end

  # unit tests for add_resource_to_team
  # Add Generic Resource to Team
  # Adds Generic Resource to the given Team
  # @param team_id An id that uniquely identifies the Team which the generic resource is to be a member of
  # @param [Hash] opts the optional parameters
  # @option opts [GenericResourceTeamMemberInput] :generic_resource_team_member_input 
  # @return [GenericResourceTeamMember]
  describe 'add_resource_to_team test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_generic_resource_team_member
  # Retrieve Generic Resource for Team
  # Retrieves an existing Generic Resource from the given Team
  # @param team_id An id that uniquely identifies the Team
  # @param resource_id An id that uniquely identifies the Generic Resource
  # @param [Hash] opts the optional parameters
  # @return [GenericResourceTeamMember]
  describe 'get_generic_resource_team_member test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_resources_in_team
  # Retrieve Generic Resources for Team
  # Retrieves a list of all Generic Resources that are members of the given Team
  # @param team_id An id that uniquely identifies the Team from which generic resources are to be retrieved
  # @param [Hash] opts the optional parameters
  # @return [GenericResourceTeamMembers]
  describe 'get_resources_in_team test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for remove_generic_resource_from_team
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'remove_generic_resource_from_team test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
