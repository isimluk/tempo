...
describe 'SkillsApi' do
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_skill test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_skill
  # Retrieve Skill
  # Retrieves an existing Skill for the given id
  # @param id An id that uniquely identifies the Skill
  # @param [Hash] opts the optional parameters
  # @return [Skill]
  describe 'get_skill test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_skills
  # Retrieve Skills
  ...
  describe 'get_skills test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_skill
  # Update Skill
