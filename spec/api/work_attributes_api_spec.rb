...
# Unit tests for OpenapiClient::WorkAttributesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WorkAttributesApi' do
  before do
  ...
  describe 'test an instance of WorkAttributesApi' do
    it 'should create an instance of WorkAttributesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::WorkAttributesApi)
    end
  end

  # unit tests for create_work_attributes
  ...
  describe 'create_work_attributes test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_work_attribute_by_key
  # Delete Work Attribute
  # Deletes an existing Work Attribute for the given key
  # @param key 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_work_attribute_by_key test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_work_attribute_by_key
  # Retrieve Work Attribute
  # Retrieves an existing Work Attribute for the given key
  # @param key 
  # @param [Hash] opts the optional parameters
  # @return [WorkAttribute]
  describe 'get_work_attribute_by_key test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_work_attributes
  ...
  describe 'get_work_attributes test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_work_attribute_by_key
  ...
  # @return [WorkAttribute]
  describe 'update_work_attribute_by_key test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
