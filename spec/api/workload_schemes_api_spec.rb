...
# Unit tests for OpenapiClient::WorkloadSchemesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WorkloadSchemesApi' do
  before do
  ...
  describe 'test an instance of WorkloadSchemesApi' do
    it 'should create an instance of WorkloadSchemesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::WorkloadSchemesApi)
    end
  end

  # unit tests for create_workload_scheme
  ...
  describe 'create_workload_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_workload_scheme
  # Delete Workload Scheme
  # Deletes a Workload Scheme for the given id
  # @param id ID of the workload scheme
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_workload_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_user_workload_scheme
  ...
  # @param [Hash] opts the optional parameters
  # @return [WorkloadScheme]
  describe 'get_user_workload_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_workload_scheme_by_id
  # Retrieve Workload Scheme
  # Retrieves an existing Workload Scheme for the given id
  # @param id ID of the workload scheme
  # @param [Hash] opts the optional parameters
  # @return [WorkloadScheme]
  describe 'get_workload_scheme_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_workload_scheme_members1
  ...
  # @return [PageableUser]
  describe 'get_workload_scheme_members1 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_workload_schemes
  ...
  describe 'get_workload_schemes test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for set_default_workload_scheme
  # Set default Workload Scheme
  # Sets the given Workload Scheme as default
  # @param id ID of the workload scheme
  # @param [Hash] opts the optional parameters
  # @return [WorkloadScheme]
  describe 'set_default_workload_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for set_workload_scheme_for_users
  ...
  # @return [nil]
  describe 'set_workload_scheme_for_users test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_workload_scheme
  ...
  # @option opts [WorkloadSchemeInput] :workload_scheme_input 
  # @return [WorkloadScheme]
  describe 'update_workload_scheme test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
