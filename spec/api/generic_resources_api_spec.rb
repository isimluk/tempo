...
# Unit tests for OpenapiClient::GenericResourcesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GenericResourcesApi' do
  before do
  ...
  describe 'test an instance of GenericResourcesApi' do
    it 'should create an instance of GenericResourcesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::GenericResourcesApi)
    end
  end

  # unit tests for create_generic_resource
  ...
  describe 'create_generic_resource test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_generic_resource
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_generic_resource test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for edit_generic_resource
  ...
  # @option opts [GenericResourceInput] :generic_resource_input 
  # @return [GenericResource]
  describe 'edit_generic_resource test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_generic_resource
  # Retrieve Generic Resource
  # Retrieves an existing Generic Resource for the given id
  # @param id An id that uniquely identifies the Generic Resource
  # @param [Hash] opts the optional parameters
  # @return [GenericResource]
  describe 'get_generic_resource test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for search_generic_resources
  ...
  describe 'search_generic_resources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
