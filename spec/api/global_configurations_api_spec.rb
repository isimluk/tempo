...
# Unit tests for OpenapiClient::GlobalConfigurationsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GlobalConfigurationsApi' do
  before do
  ...
  describe 'test an instance of GlobalConfigurationsApi' do
    it 'should create an instance of GlobalConfigurationsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::GlobalConfigurationsApi)
    end
  end

  # unit tests for get_global_configuration
  # Retrieve Global Configurations
  # Retrieves the Global Configurations
  # @param [Hash] opts the optional parameters
  # @return [GlobalConfiguration]
  describe 'get_global_configuration test' do
    it 'should work' do
