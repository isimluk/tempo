...
# Unit tests for OpenapiClient::RoleResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RoleResults do
  let(:instance) { OpenapiClient::RoleResults.new }

  describe 'test an instance of RoleResults' do
    it 'should create an instance of RoleResults' do
      expect(instance).to be_instance_of(OpenapiClient::RoleResults)
    end
  end
