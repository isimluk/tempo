...
# Unit tests for OpenapiClient::PlanApprovalInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanApprovalInput do
  let(:instance) { OpenapiClient::PlanApprovalInput.new }

  describe 'test an instance of PlanApprovalInput' do
    it 'should create an instance of PlanApprovalInput' do
      expect(instance).to be_instance_of(OpenapiClient::PlanApprovalInput)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["APPROVED", "REJECTED", "REQUESTED"])
