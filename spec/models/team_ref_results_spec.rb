...
# Unit tests for OpenapiClient::TeamRefResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamRefResults do
  let(:instance) { OpenapiClient::TeamRefResults.new }

  describe 'test an instance of TeamRefResults' do
    it 'should create an instance of TeamRefResults' do
      expect(instance).to be_instance_of(OpenapiClient::TeamRefResults)
    end
  end
