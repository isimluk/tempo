...
# Unit tests for OpenapiClient::HolidaySchemeResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HolidaySchemeResults do
  let(:instance) { OpenapiClient::HolidaySchemeResults.new }

  describe 'test an instance of HolidaySchemeResults' do
    it 'should create an instance of HolidaySchemeResults' do
      expect(instance).to be_instance_of(OpenapiClient::HolidaySchemeResults)
    end
  end
