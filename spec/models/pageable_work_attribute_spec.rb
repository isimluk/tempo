...
# Unit tests for OpenapiClient::PageableWorkAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableWorkAttribute do
  let(:instance) { OpenapiClient::PageableWorkAttribute.new }

  describe 'test an instance of PageableWorkAttribute' do
    it 'should create an instance of PageableWorkAttribute' do
      expect(instance).to be_instance_of(OpenapiClient::PageableWorkAttribute)
    end
  end
