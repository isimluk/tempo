...
# Unit tests for OpenapiClient::GenericResourceTeamMember
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GenericResourceTeamMember do
  let(:instance) { OpenapiClient::GenericResourceTeamMember.new }

  describe 'test an instance of GenericResourceTeamMember' do
    it 'should create an instance of GenericResourceTeamMember' do
      expect(instance).to be_instance_of(OpenapiClient::GenericResourceTeamMember)
    end
  end
  describe 'test attribute "assigned_to_team_at"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "assigned_to_team_by"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
