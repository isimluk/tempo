...
# Unit tests for OpenapiClient::AccountLinkInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AccountLinkInput do
  let(:instance) { OpenapiClient::AccountLinkInput.new }

  describe 'test an instance of AccountLinkInput' do
    it 'should create an instance of AccountLinkInput' do
      expect(instance).to be_instance_of(OpenapiClient::AccountLinkInput)
    end
  end
  ...
  describe 'test attribute "scope_type"' do
    it 'should work' do
      ...
      #   expect { instance.scope_type = value }.not_to raise_error
      # end
    end
  end
