...
# Unit tests for OpenapiClient::PlanAssignee
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanAssignee do
  let(:instance) { OpenapiClient::PlanAssignee.new }

  describe 'test an instance of PlanAssignee' do
    it 'should create an instance of PlanAssignee' do
      expect(instance).to be_instance_of(OpenapiClient::PlanAssignee)
    end
  end
