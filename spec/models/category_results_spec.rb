...
# Unit tests for OpenapiClient::CategoryResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CategoryResults do
  let(:instance) { OpenapiClient::CategoryResults.new }

  describe 'test an instance of CategoryResults' do
    it 'should create an instance of CategoryResults' do
      expect(instance).to be_instance_of(OpenapiClient::CategoryResults)
    end
  end
