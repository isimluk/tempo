...
# Unit tests for OpenapiClient::CreateWorkAttributeInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateWorkAttributeInput do
  let(:instance) { OpenapiClient::CreateWorkAttributeInput.new }

  describe 'test an instance of CreateWorkAttributeInput' do
    it 'should create an instance of CreateWorkAttributeInput' do
      expect(instance).to be_instance_of(OpenapiClient::CreateWorkAttributeInput)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ACCOUNT", "CHECKBOX", "INPUT_FIELD", "INPUT_NUMERIC", "STATIC_LIST"])
