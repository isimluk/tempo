...
# Unit tests for OpenapiClient::CategoryTypeResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CategoryTypeResults do
  let(:instance) { OpenapiClient::CategoryTypeResults.new }

  describe 'test an instance of CategoryTypeResults' do
    it 'should create an instance of CategoryTypeResults' do
      expect(instance).to be_instance_of(OpenapiClient::CategoryTypeResults)
    end
  end
