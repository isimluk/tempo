...
# Unit tests for OpenapiClient::PlanPeriod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanPeriod do
  let(:instance) { OpenapiClient::PlanPeriod.new }

  describe 'test an instance of PlanPeriod' do
    it 'should create an instance of PlanPeriod' do
      expect(instance).to be_instance_of(OpenapiClient::PlanPeriod)
    end
  end
  ...
  describe 'test attribute "planned_seconds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
