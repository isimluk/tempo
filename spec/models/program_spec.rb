...
# Unit tests for OpenapiClient::Program
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Program do
  let(:instance) { OpenapiClient::Program.new }

  describe 'test an instance of Program' do
    it 'should create an instance of Program' do
      expect(instance).to be_instance_of(OpenapiClient::Program)
    end
  end
