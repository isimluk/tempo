...
# Unit tests for OpenapiClient::TimesheetApprovalAvailableActions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimesheetApprovalAvailableActions do
  let(:instance) { OpenapiClient::TimesheetApprovalAvailableActions.new }

  describe 'test an instance of TimesheetApprovalAvailableActions' do
    it 'should create an instance of TimesheetApprovalAvailableActions' do
      expect(instance).to be_instance_of(OpenapiClient::TimesheetApprovalAvailableActions)
    end
  end
  ...
  describe 'test attribute "reopen"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
