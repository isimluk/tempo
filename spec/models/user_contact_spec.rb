...
# Unit tests for OpenapiClient::UserContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UserContact do
  let(:instance) { OpenapiClient::UserContact.new }

  describe 'test an instance of UserContact' do
    it 'should create an instance of UserContact' do
      expect(instance).to be_instance_of(OpenapiClient::UserContact)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["USER", "EXTERNAL"])
