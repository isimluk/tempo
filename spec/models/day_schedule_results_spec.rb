...
# Unit tests for OpenapiClient::DayScheduleResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DayScheduleResults do
  let(:instance) { OpenapiClient::DayScheduleResults.new }

  describe 'test an instance of DayScheduleResults' do
    it 'should create an instance of DayScheduleResults' do
      expect(instance).to be_instance_of(OpenapiClient::DayScheduleResults)
    end
  end
