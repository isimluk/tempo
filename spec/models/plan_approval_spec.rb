...
# Unit tests for OpenapiClient::PlanApproval
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanApproval do
  let(:instance) { OpenapiClient::PlanApproval.new }

  describe 'test an instance of PlanApproval' do
    it 'should create an instance of PlanApproval' do
      expect(instance).to be_instance_of(OpenapiClient::PlanApproval)
    end
  end
