...
# Unit tests for OpenapiClient::AccountLinkResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AccountLinkResults do
  let(:instance) { OpenapiClient::AccountLinkResults.new }

  describe 'test an instance of AccountLinkResults' do
    it 'should create an instance of AccountLinkResults' do
      expect(instance).to be_instance_of(OpenapiClient::AccountLinkResults)
    end
  end
