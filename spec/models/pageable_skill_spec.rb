...
# Unit tests for OpenapiClient::PageableSkill
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableSkill do
  let(:instance) { OpenapiClient::PageableSkill.new }

  describe 'test an instance of PageableSkill' do
    it 'should create an instance of PageableSkill' do
      expect(instance).to be_instance_of(OpenapiClient::PageableSkill)
    end
  end
