...
# Unit tests for OpenapiClient::WorkAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorkAttribute do
  let(:instance) { OpenapiClient::WorkAttribute.new }

  describe 'test an instance of WorkAttribute' do
    it 'should create an instance of WorkAttribute' do
      expect(instance).to be_instance_of(OpenapiClient::WorkAttribute)
    end
  end
