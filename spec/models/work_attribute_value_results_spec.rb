...
# Unit tests for OpenapiClient::WorkAttributeValueResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorkAttributeValueResults do
  let(:instance) { OpenapiClient::WorkAttributeValueResults.new }

  describe 'test an instance of WorkAttributeValueResults' do
    it 'should create an instance of WorkAttributeValueResults' do
      expect(instance).to be_instance_of(OpenapiClient::WorkAttributeValueResults)
    end
  end
