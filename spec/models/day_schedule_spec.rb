...
# Unit tests for OpenapiClient::DaySchedule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DaySchedule do
  let(:instance) { OpenapiClient::DaySchedule.new }

  describe 'test an instance of DaySchedule' do
    it 'should create an instance of DaySchedule' do
      expect(instance).to be_instance_of(OpenapiClient::DaySchedule)
    end
  end
  ...
  describe 'test attribute "required_seconds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["WORKING_DAY", "NON_WORKING_DAY", "HOLIDAY", "HOLIDAY_AND_NON_WORKING_DAY"])
