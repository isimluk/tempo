...
# Unit tests for OpenapiClient::WorkloadScheme
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorkloadScheme do
  let(:instance) { OpenapiClient::WorkloadScheme.new }

  describe 'test an instance of WorkloadScheme' do
    it 'should create an instance of WorkloadScheme' do
      expect(instance).to be_instance_of(OpenapiClient::WorkloadScheme)
    end
  end
  ...
  describe 'test attribute "default_scheme"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
