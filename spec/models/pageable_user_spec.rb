...
# Unit tests for OpenapiClient::PageableUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableUser do
  let(:instance) { OpenapiClient::PageableUser.new }

  describe 'test an instance of PageableUser' do
    it 'should create an instance of PageableUser' do
      expect(instance).to be_instance_of(OpenapiClient::PageableUser)
    end
  end
