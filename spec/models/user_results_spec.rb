...
# Unit tests for OpenapiClient::UserResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UserResults do
  let(:instance) { OpenapiClient::UserResults.new }

  describe 'test an instance of UserResults' do
    it 'should create an instance of UserResults' do
      expect(instance).to be_instance_of(OpenapiClient::UserResults)
    end
  end
