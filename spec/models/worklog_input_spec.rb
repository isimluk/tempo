...
# Unit tests for OpenapiClient::WorklogInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorklogInput do
  let(:instance) { OpenapiClient::WorklogInput.new }

  describe 'test an instance of WorklogInput' do
    it 'should create an instance of WorklogInput' do
      expect(instance).to be_instance_of(OpenapiClient::WorklogInput)
    end
  end
  ...
  describe 'test attribute "author_account_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "remaining_estimate_seconds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
