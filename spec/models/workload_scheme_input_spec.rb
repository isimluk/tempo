...
# Unit tests for OpenapiClient::WorkloadSchemeInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorkloadSchemeInput do
  let(:instance) { OpenapiClient::WorkloadSchemeInput.new }

  describe 'test an instance of WorkloadSchemeInput' do
    it 'should create an instance of WorkloadSchemeInput' do
      expect(instance).to be_instance_of(OpenapiClient::WorkloadSchemeInput)
    end
  end
