...
# Unit tests for OpenapiClient::PlanItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanItem do
  let(:instance) { OpenapiClient::PlanItem.new }

  describe 'test an instance of PlanItem' do
    it 'should create an instance of PlanItem' do
      expect(instance).to be_instance_of(OpenapiClient::PlanItem)
    end
  end
