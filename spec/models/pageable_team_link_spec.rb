...
# Unit tests for OpenapiClient::PageableTeamLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableTeamLink do
  let(:instance) { OpenapiClient::PageableTeamLink.new }

  describe 'test an instance of PageableTeamLink' do
    it 'should create an instance of PageableTeamLink' do
      expect(instance).to be_instance_of(OpenapiClient::PageableTeamLink)
    end
  end
