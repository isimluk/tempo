...
# Unit tests for OpenapiClient::PageableAccountLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableAccountLink do
  let(:instance) { OpenapiClient::PageableAccountLink.new }

  describe 'test an instance of PageableAccountLink' do
    it 'should create an instance of PageableAccountLink' do
      expect(instance).to be_instance_of(OpenapiClient::PageableAccountLink)
    end
  end
