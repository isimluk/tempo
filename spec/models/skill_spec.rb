...
# Unit tests for OpenapiClient::Skill
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Skill do
  let(:instance) { OpenapiClient::Skill.new }

  describe 'test an instance of Skill' do
    it 'should create an instance of Skill' do
      expect(instance).to be_instance_of(OpenapiClient::Skill)
    end
  end
