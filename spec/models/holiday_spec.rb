...
# Unit tests for OpenapiClient::Holiday
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Holiday do
  let(:instance) { OpenapiClient::Holiday.new }

  describe 'test an instance of Holiday' do
    it 'should create an instance of Holiday' do
      expect(instance).to be_instance_of(OpenapiClient::Holiday)
    end
  end
