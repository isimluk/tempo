...
# Unit tests for OpenapiClient::TeamRef
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamRef do
  let(:instance) { OpenapiClient::TeamRef.new }

  describe 'test an instance of TeamRef' do
    it 'should create an instance of TeamRef' do
      expect(instance).to be_instance_of(OpenapiClient::TeamRef)
    end
  end
