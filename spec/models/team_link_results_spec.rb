...
# Unit tests for OpenapiClient::TeamLinkResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamLinkResults do
  let(:instance) { OpenapiClient::TeamLinkResults.new }

  describe 'test an instance of TeamLinkResults' do
    it 'should create an instance of TeamLinkResults' do
      expect(instance).to be_instance_of(OpenapiClient::TeamLinkResults)
    end
  end
