...
# Unit tests for OpenapiClient::ProgramReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ProgramReference do
  let(:instance) { OpenapiClient::ProgramReference.new }

  describe 'test an instance of ProgramReference' do
    it 'should create an instance of ProgramReference' do
      expect(instance).to be_instance_of(OpenapiClient::ProgramReference)
    end
  end
