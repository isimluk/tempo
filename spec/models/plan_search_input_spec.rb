...
# Unit tests for OpenapiClient::PlanSearchInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanSearchInput do
  let(:instance) { OpenapiClient::PlanSearchInput.new }

  describe 'test an instance of PlanSearchInput' do
    it 'should create an instance of PlanSearchInput' do
      expect(instance).to be_instance_of(OpenapiClient::PlanSearchInput)
    end
  end
  ...
  describe 'test attribute "assignee_types"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["USER", "GENERIC"])
      # validator.allowable_values.each do |value|
      #   expect { instance.assignee_types = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "generic_resource_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "plan_item_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "plan_item_types"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["ISSUE", "PROJECT"])
      # validator.allowable_values.each do |value|
      #   expect { instance.plan_item_types = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "planned_time_breakdown"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["DAILY", "PERIOD"])
      # validator.allowable_values.each do |value|
      #   expect { instance.planned_time_breakdown = value }.not_to raise_error
      # end
    end
  end
