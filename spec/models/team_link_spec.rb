...
# Unit tests for OpenapiClient::TeamLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamLink do
  let(:instance) { OpenapiClient::TeamLink.new }

  describe 'test an instance of TeamLink' do
    it 'should create an instance of TeamLink' do
      expect(instance).to be_instance_of(OpenapiClient::TeamLink)
    end
  end
