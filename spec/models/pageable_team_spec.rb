...
# Unit tests for OpenapiClient::PageableTeam
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableTeam do
  let(:instance) { OpenapiClient::PageableTeam.new }

  describe 'test an instance of PageableTeam' do
    it 'should create an instance of PageableTeam' do
      expect(instance).to be_instance_of(OpenapiClient::PageableTeam)
    end
  end
