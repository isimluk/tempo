...
# Unit tests for OpenapiClient::PageableMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableMetadata do
  let(:instance) { OpenapiClient::PageableMetadata.new }

  describe 'test an instance of PageableMetadata' do
    it 'should create an instance of PageableMetadata' do
      expect(instance).to be_instance_of(OpenapiClient::PageableMetadata)
    end
  end
