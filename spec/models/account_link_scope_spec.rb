...
# Unit tests for OpenapiClient::AccountLinkScope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AccountLinkScope do
  let(:instance) { OpenapiClient::AccountLinkScope.new }

  describe 'test an instance of AccountLinkScope' do
    it 'should create an instance of AccountLinkScope' do
      expect(instance).to be_instance_of(OpenapiClient::AccountLinkScope)
    end
  end
