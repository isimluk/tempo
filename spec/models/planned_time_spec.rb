...
# Unit tests for OpenapiClient::PlannedTime
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlannedTime do
  let(:instance) { OpenapiClient::PlannedTime.new }

  describe 'test an instance of PlannedTime' do
    it 'should create an instance of PlannedTime' do
      expect(instance).to be_instance_of(OpenapiClient::PlannedTime)
    end
  end
