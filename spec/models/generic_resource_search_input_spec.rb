...
# Unit tests for OpenapiClient::GenericResourceSearchInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GenericResourceSearchInput do
  let(:instance) { OpenapiClient::GenericResourceSearchInput.new }

  describe 'test an instance of GenericResourceSearchInput' do
    it 'should create an instance of GenericResourceSearchInput' do
      expect(instance).to be_instance_of(OpenapiClient::GenericResourceSearchInput)
    end
  end
