...
# Unit tests for OpenapiClient::PlanInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanInput do
  let(:instance) { OpenapiClient::PlanInput.new }

  describe 'test an instance of PlanInput' do
    it 'should create an instance of PlanInput' do
      expect(instance).to be_instance_of(OpenapiClient::PlanInput)
    end
  end
  ...
  describe 'test attribute "assignee_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["USER", "GENERIC"])
      # validator.allowable_values.each do |value|
      #   expect { instance.assignee_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "include_non_working_days"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "plan_approval"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "plan_item_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "plan_item_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ISSUE", "PROJECT"])
      # validator.allowable_values.each do |value|
      #   expect { instance.plan_item_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "planned_seconds_per_day"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "recurrence_end_date"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "rule"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["NEVER", "WEEKLY", "BI_WEEKLY", "MONTHLY"])
      # validator.allowable_values.each do |value|
