...
# Unit tests for OpenapiClient::TeamMembershipResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamMembershipResults do
  let(:instance) { OpenapiClient::TeamMembershipResults.new }

  describe 'test an instance of TeamMembershipResults' do
    it 'should create an instance of TeamMembershipResults' do
      expect(instance).to be_instance_of(OpenapiClient::TeamMembershipResults)
    end
  end
