...
# Unit tests for OpenapiClient::WorkloadSchemeDayInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorkloadSchemeDayInput do
  let(:instance) { OpenapiClient::WorkloadSchemeDayInput.new }

  describe 'test an instance of WorkloadSchemeDayInput' do
    it 'should create an instance of WorkloadSchemeDayInput' do
      expect(instance).to be_instance_of(OpenapiClient::WorkloadSchemeDayInput)
    end
  end
