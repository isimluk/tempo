...
# Unit tests for OpenapiClient::TimesheetApproval
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimesheetApproval do
  let(:instance) { OpenapiClient::TimesheetApproval.new }

  describe 'test an instance of TimesheetApproval' do
    it 'should create an instance of TimesheetApproval' do
      expect(instance).to be_instance_of(OpenapiClient::TimesheetApproval)
    end
  end
  ...
  describe 'test attribute "time_spent_seconds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "worklogs"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
