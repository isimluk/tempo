...
# Unit tests for OpenapiClient::SkillsAssignmentInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SkillsAssignmentInput do
  let(:instance) { OpenapiClient::SkillsAssignmentInput.new }

  describe 'test an instance of SkillsAssignmentInput' do
    it 'should create an instance of SkillsAssignmentInput' do
      expect(instance).to be_instance_of(OpenapiClient::SkillsAssignmentInput)
    end
  end
  ...
  describe 'test attribute "skill_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
