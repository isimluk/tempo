...
# Unit tests for OpenapiClient::PageableWorklog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableWorklog do
  let(:instance) { OpenapiClient::PageableWorklog.new }

  describe 'test an instance of PageableWorklog' do
    it 'should create an instance of PageableWorklog' do
      expect(instance).to be_instance_of(OpenapiClient::PageableWorklog)
    end
  end
