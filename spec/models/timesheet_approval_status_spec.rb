...
# Unit tests for OpenapiClient::TimesheetApprovalStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimesheetApprovalStatus do
  let(:instance) { OpenapiClient::TimesheetApprovalStatus.new }

  describe 'test an instance of TimesheetApprovalStatus' do
    it 'should create an instance of TimesheetApprovalStatus' do
      expect(instance).to be_instance_of(OpenapiClient::TimesheetApprovalStatus)
    end
  end
  ...
  describe 'test attribute "key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["OPEN", "IN_REVIEW", "APPROVED"])
  ...
  describe 'test attribute "required_seconds_at_submit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "time_spent_seconds_at_submit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
