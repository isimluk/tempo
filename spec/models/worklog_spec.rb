...
# Unit tests for OpenapiClient::Worklog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Worklog do
  let(:instance) { OpenapiClient::Worklog.new }

  describe 'test an instance of Worklog' do
    it 'should create an instance of Worklog' do
      expect(instance).to be_instance_of(OpenapiClient::Worklog)
    end
  end
  ...
  describe 'test attribute "tempo_worklog_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
