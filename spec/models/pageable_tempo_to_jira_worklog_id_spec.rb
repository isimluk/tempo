...
# Unit tests for OpenapiClient::PageableTempoToJiraWorklogId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableTempoToJiraWorklogId do
  let(:instance) { OpenapiClient::PageableTempoToJiraWorklogId.new }

  describe 'test an instance of PageableTempoToJiraWorklogId' do
    it 'should create an instance of PageableTempoToJiraWorklogId' do
      expect(instance).to be_instance_of(OpenapiClient::PageableTempoToJiraWorklogId)
    end
  end
