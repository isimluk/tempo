...
# Unit tests for OpenapiClient::TeamLinkInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamLinkInput do
  let(:instance) { OpenapiClient::TeamLinkInput.new }

  describe 'test an instance of TeamLinkInput' do
    it 'should create an instance of TeamLinkInput' do
      expect(instance).to be_instance_of(OpenapiClient::TeamLinkInput)
    end
  end
