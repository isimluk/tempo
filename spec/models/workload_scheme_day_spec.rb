...
# Unit tests for OpenapiClient::WorkloadSchemeDay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorkloadSchemeDay do
  let(:instance) { OpenapiClient::WorkloadSchemeDay.new }

  describe 'test an instance of WorkloadSchemeDay' do
    it 'should create an instance of WorkloadSchemeDay' do
      expect(instance).to be_instance_of(OpenapiClient::WorkloadSchemeDay)
    end
  end
