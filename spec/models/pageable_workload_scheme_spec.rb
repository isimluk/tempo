...
# Unit tests for OpenapiClient::PageableWorkloadScheme
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableWorkloadScheme do
  let(:instance) { OpenapiClient::PageableWorkloadScheme.new }

  describe 'test an instance of PageableWorkloadScheme' do
    it 'should create an instance of PageableWorkloadScheme' do
      expect(instance).to be_instance_of(OpenapiClient::PageableWorkloadScheme)
    end
  end
