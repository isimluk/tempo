...
# Unit tests for OpenapiClient::PageableCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableCustomer do
  let(:instance) { OpenapiClient::PageableCustomer.new }

  describe 'test an instance of PageableCustomer' do
    it 'should create an instance of PageableCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::PageableCustomer)
    end
  end
