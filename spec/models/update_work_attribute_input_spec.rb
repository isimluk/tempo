...
# Unit tests for OpenapiClient::UpdateWorkAttributeInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateWorkAttributeInput do
  let(:instance) { OpenapiClient::UpdateWorkAttributeInput.new }

  describe 'test an instance of UpdateWorkAttributeInput' do
    it 'should create an instance of UpdateWorkAttributeInput' do
      expect(instance).to be_instance_of(OpenapiClient::UpdateWorkAttributeInput)
    end
  end
