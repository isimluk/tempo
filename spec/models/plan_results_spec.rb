...
# Unit tests for OpenapiClient::PlanResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanResults do
  let(:instance) { OpenapiClient::PlanResults.new }

  describe 'test an instance of PlanResults' do
    it 'should create an instance of PlanResults' do
      expect(instance).to be_instance_of(OpenapiClient::PlanResults)
    end
  end
