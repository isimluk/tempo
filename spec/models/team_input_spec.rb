...
# Unit tests for OpenapiClient::TeamInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamInput do
  let(:instance) { OpenapiClient::TeamInput.new }

  describe 'test an instance of TeamInput' do
    it 'should create an instance of TeamInput' do
      expect(instance).to be_instance_of(OpenapiClient::TeamInput)
    end
  end
