...
# Unit tests for OpenapiClient::WorklogSearchInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WorklogSearchInput do
  let(:instance) { OpenapiClient::WorklogSearchInput.new }

  describe 'test an instance of WorklogSearchInput' do
    it 'should create an instance of WorklogSearchInput' do
      expect(instance).to be_instance_of(OpenapiClient::WorklogSearchInput)
    end
  end
  describe 'test attribute "author_ids"' do
    it 'should work' do
  ...
  describe 'test attribute "issue_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
