...
# Unit tests for OpenapiClient::PermissionRoleInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PermissionRoleInput do
  let(:instance) { OpenapiClient::PermissionRoleInput.new }

  describe 'test an instance of PermissionRoleInput' do
    it 'should create an instance of PermissionRoleInput' do
      expect(instance).to be_instance_of(OpenapiClient::PermissionRoleInput)
    end
  end
  describe 'test attribute "access_entity_ids"' do
    it 'should work' do
  ...
  describe 'test attribute "access_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["TEAM", "GLOBAL"])
  ...
  describe 'test attribute "permission_keys"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "permitted_account_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
