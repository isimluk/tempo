...
# Unit tests for OpenapiClient::CategoryInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CategoryInput do
  let(:instance) { OpenapiClient::CategoryInput.new }

  describe 'test an instance of CategoryInput' do
    it 'should create an instance of CategoryInput' do
      expect(instance).to be_instance_of(OpenapiClient::CategoryInput)
    end
  end
  ...
  describe 'test attribute "type_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BILLABLE", "CAPITALIZED", "INTERNAL", "OPERATIONAL"])
      # validator.allowable_values.each do |value|
      #   expect { instance.type_name = value }.not_to raise_error
      # end
    end
  end
