...
# Unit tests for OpenapiClient::RoleReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RoleReference do
  let(:instance) { OpenapiClient::RoleReference.new }

  describe 'test an instance of RoleReference' do
    it 'should create an instance of RoleReference' do
      expect(instance).to be_instance_of(OpenapiClient::RoleReference)
    end
  end
