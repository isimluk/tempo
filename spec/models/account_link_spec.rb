...
# Unit tests for OpenapiClient::AccountLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AccountLink do
  let(:instance) { OpenapiClient::AccountLink.new }

  describe 'test an instance of AccountLink' do
    it 'should create an instance of AccountLink' do
      expect(instance).to be_instance_of(OpenapiClient::AccountLink)
    end
  end
