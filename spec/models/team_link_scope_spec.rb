...
# Unit tests for OpenapiClient::TeamLinkScope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamLinkScope do
  let(:instance) { OpenapiClient::TeamLinkScope.new }

  describe 'test an instance of TeamLinkScope' do
    it 'should create an instance of TeamLinkScope' do
      expect(instance).to be_instance_of(OpenapiClient::TeamLinkScope)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BOARD", "PROJECT"])
