...
# Unit tests for OpenapiClient::PermissionRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PermissionRole do
  let(:instance) { OpenapiClient::PermissionRole.new }

  describe 'test an instance of PermissionRole' do
    it 'should create an instance of PermissionRole' do
      expect(instance).to be_instance_of(OpenapiClient::PermissionRole)
    end
  end
  describe 'test attribute "access_entities"' do
    it 'should work' do
  ...
  describe 'test attribute "permitted_users"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
