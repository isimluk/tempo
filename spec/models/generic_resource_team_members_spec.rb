...
# Unit tests for OpenapiClient::GenericResourceTeamMembers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GenericResourceTeamMembers do
  let(:instance) { OpenapiClient::GenericResourceTeamMembers.new }

  describe 'test an instance of GenericResourceTeamMembers' do
    it 'should create an instance of GenericResourceTeamMembers' do
      expect(instance).to be_instance_of(OpenapiClient::GenericResourceTeamMembers)
    end
  end
