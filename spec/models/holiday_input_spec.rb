...
# Unit tests for OpenapiClient::HolidayInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HolidayInput do
  let(:instance) { OpenapiClient::HolidayInput.new }

  describe 'test an instance of HolidayInput' do
    it 'should create an instance of HolidayInput' do
      expect(instance).to be_instance_of(OpenapiClient::HolidayInput)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["FIXED", "FLOATING"])
