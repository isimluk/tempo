...
# Unit tests for OpenapiClient::TeamMembershipInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamMembershipInput do
  let(:instance) { OpenapiClient::TeamMembershipInput.new }

  describe 'test an instance of TeamMembershipInput' do
    it 'should create an instance of TeamMembershipInput' do
      expect(instance).to be_instance_of(OpenapiClient::TeamMembershipInput)
    end
  end
  ...
  describe 'test attribute "commitment_percent"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
