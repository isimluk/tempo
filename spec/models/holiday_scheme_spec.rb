...
# Unit tests for OpenapiClient::HolidayScheme
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HolidayScheme do
  let(:instance) { OpenapiClient::HolidayScheme.new }

  describe 'test an instance of HolidayScheme' do
    it 'should create an instance of HolidayScheme' do
      expect(instance).to be_instance_of(OpenapiClient::HolidayScheme)
    end
  end
