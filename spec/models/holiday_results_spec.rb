...
# Unit tests for OpenapiClient::HolidayResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HolidayResults do
  let(:instance) { OpenapiClient::HolidayResults.new }

  describe 'test an instance of HolidayResults' do
    it 'should create an instance of HolidayResults' do
      expect(instance).to be_instance_of(OpenapiClient::HolidayResults)
    end
  end
