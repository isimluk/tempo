...
# Unit tests for OpenapiClient::PageablePermissionRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageablePermissionRole do
  let(:instance) { OpenapiClient::PageablePermissionRole.new }

  describe 'test an instance of PageablePermissionRole' do
    it 'should create an instance of PageablePermissionRole' do
      expect(instance).to be_instance_of(OpenapiClient::PageablePermissionRole)
    end
  end
