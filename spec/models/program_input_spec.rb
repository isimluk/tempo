...
# Unit tests for OpenapiClient::ProgramInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ProgramInput do
  let(:instance) { OpenapiClient::ProgramInput.new }

  describe 'test an instance of ProgramInput' do
    it 'should create an instance of ProgramInput' do
      expect(instance).to be_instance_of(OpenapiClient::ProgramInput)
    end
  end
  describe 'test attribute "manager_account_id"' do
    it 'should work' do
