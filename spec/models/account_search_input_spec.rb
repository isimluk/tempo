...
# Unit tests for OpenapiClient::AccountSearchInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AccountSearchInput do
  let(:instance) { OpenapiClient::AccountSearchInput.new }

  describe 'test an instance of AccountSearchInput' do
    it 'should create an instance of AccountSearchInput' do
      expect(instance).to be_instance_of(OpenapiClient::AccountSearchInput)
    end
  end
  ...
  describe 'test attribute "statuses"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["OPEN", "CLOSED", "ARCHIVED"])
