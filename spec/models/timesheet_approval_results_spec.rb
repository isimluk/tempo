...
# Unit tests for OpenapiClient::TimesheetApprovalResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimesheetApprovalResults do
  let(:instance) { OpenapiClient::TimesheetApprovalResults.new }

  describe 'test an instance of TimesheetApprovalResults' do
    it 'should create an instance of TimesheetApprovalResults' do
      expect(instance).to be_instance_of(OpenapiClient::TimesheetApprovalResults)
    end
  end
