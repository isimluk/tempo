...
# Unit tests for OpenapiClient::ProgramResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ProgramResults do
  let(:instance) { OpenapiClient::ProgramResults.new }

  describe 'test an instance of ProgramResults' do
    it 'should create an instance of ProgramResults' do
      expect(instance).to be_instance_of(OpenapiClient::ProgramResults)
    end
  end
