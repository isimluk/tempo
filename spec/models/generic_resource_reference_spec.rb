...
# Unit tests for OpenapiClient::GenericResourceReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GenericResourceReference do
  let(:instance) { OpenapiClient::GenericResourceReference.new }

  describe 'test an instance of GenericResourceReference' do
    it 'should create an instance of GenericResourceReference' do
      expect(instance).to be_instance_of(OpenapiClient::GenericResourceReference)
    end
  end
