...
# Unit tests for OpenapiClient::PageableAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageableAccount do
  let(:instance) { OpenapiClient::PageableAccount.new }

  describe 'test an instance of PageableAccount' do
    it 'should create an instance of PageableAccount' do
      expect(instance).to be_instance_of(OpenapiClient::PageableAccount)
    end
  end
